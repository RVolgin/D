label dct_4th_shift:
    ...
    show headline_text u"Четвертая смена" at truecenter with dspr
    $ renpy.pause(5.0)
...
label d_duo:
    ...
    dreamgirl "Вся эта история началась на четвёртый день смены, перед обедом."
    dreamgirl "Ульянка, поднырнув под створки хозяйственных ворот лагеря, выбралась на волю и решала, как ей реализовать полученые возможности."
    ...
    dreamgirl "Но пока Ульянка думала и крутила головой вправо-влево, выбирая между реальными и соблазнительными малинником и рекой, и недостоверной, но зато романтично-загадочной кошкодевочкой, жизнь все решила за неё."
    play sound dct_sfx_grass_steps
    dreamgirl "Со стороны леса послышались голоса и на старый, заросший травой асфальт площадки перед воротами вышли двое."
    th "Стоп! А это ещё кто?" with hpunch
    dreamgirl "Первой шла невысокая девушка лет девятнадцати. Красная футболка, почти такая же, как у Ульяны; джинсы, обрезанные до колен; кеды и противогазная сумка через плечо."
    show us surp1 sport normal with dspr
    ...
    dreamgirl "Пионерка вздрогнула, но почти сразу поняла, что обращаются не к ней, а к гостье."
    dreamgirl "Вторым на поляну вышел парень лет двадцати пяти, высокий, худой, с копной каштановых волос, зачёсанных назад, в вожатской форме, но без галстука, только с каким-то черным шнурком на шее, прячущимся под рубашкой, и с выгоревшим на солнце, а когда-то голубым, рюкзаком за плечами."
    ...
    hide us
    with dspr
    dreamgirl "Парень молча кивнул головой, благодаря, а девушка поправила волну медно-красных волос на плечах, и ещё раз улыбнулась Ульяне."
    dreamgirl "Парочка, обойдя Ульянку, прошла к воротам, а Ульянка смотрела им вслед и думала, где она могла их видеть, особенно парня."
    ...
    dreamgirl "У ворот парень подёргал створки, потрогал, сквозь щель между ними, висячий замок, запирающий ворота, удивлённо качнул головой и сказал, обращаясь к спутнице."
    ...
    dreamgirl "Тут парень глянул на подошедшую поближе Ульяну."
    ...
    d_u1 "Зануда."
    hide d_us with dspr
    dreamgirl "Коротко ответила девушка и полезла под ворота."
    hide d_sf with dspr
    dreamgirl "А когда парень, кряхтя и как-то с трудом и неестественно сгибаясь, полез следом, уже с той стороны ворот, добавила."
    d_u1 "Вот влюбилась же в зануду."
    dreamgirl "И уже другим голосом спросила."
    ...
    dreamgirl "Запах тайны и приключений был так силен, что Ульянка, едва подождав, пока пришельцы отойдут от ворот, полезла за ними следом и так и сопровождала парочку до самого медпункта, стараясь не пропустить ни одного слова."
    ...
    show d_us normal sport at fright:
        ypos -0.05
    with dspr
    d_u1 "Вот видишь, ты сам все понимаешь. Но не исправляешься."
    hide d_us
    show d_sf normal pioneer at fleft
    with dspr
    ...
    show d_us normal sport at fright:
        ypos -0.05
    with dspr
    d_u1 "Здесь пускай свою слезу, старче, вот хоть у той берёзы. Сам же говорил, что все тут облазил лучше, чем здешняя я."
    ...
    show us surp1 sport
    with dspr
    th "Идите по медленнее. Я же не успеваю! Мне же ещё и прятаться от вас приходится."
    hide us
    ...
    me "Все-таки лагеря разные, хоть и очень похожие, и вот сейчас эти различия, эти детали… От понимания и узнавания этих деталей."
    ...
    with dissolve
    play ambience ambience_camp_center_day
    dreamgirl "Когда пришельцы вышли к медпункту, Виола уже запирала дверь, собираясь идти в столовую. Тут же рядом приплясывал и Толик, живущий в изоляторе."
    dreamgirl "Как выяснила Ульянка, Толик был чьим-то родственником: может, вожатой, может, кого из поварих, а может, самой Виолы."
    dreamgirl "Вот, кто-то из них, пользуясь служебным положением, и привёз убогого в лагерь."
    dreamgirl "Вреда от него, впрочем, не было, а дразнить его было неинтересно, это Ульяна выяснила в первый же день — Толик жил в каком-то своем мире, и на окружающих просто не реагировал."
    show d_sf normal pioneer at fright with moveinright
    ...
    dreamgirl "Толик повернул голову на звук, замычал, показывая правой рукой на пришельцев, а левую спрятав себе за спину, сделал шаг и оказалось, что он стоит уже между пришельцами и Виолой."
    show d_to normal pioneer with pixellate
    $ renpy.pause (1)
    show d_to moron pioneer with pixellate
    dreamgirl "Воздух вокруг Толика вдруг странно замерцал, искажая его привычный облик. Кажется, даже его рост начал изменяться. Несколько секунд и всё закончилось."
    dreamgirl "Он все так же придурковато улыбался и пускал слюну, но Ульянка успела поймать мелькнувшее выражение глаз Толика, очень жёсткое и безжалостное, и что-то чёрное мелькнуло в его руке, мелькнуло и исчезло."
    dreamgirl "Виола же, бросив возиться с дверью, потянула из кармана халата какой-то прибор, тоже разворачиваясь лицом к гостям."
    me "Не придуривайся, Толяныч."
    dreamgirl "И, похоже, слова парня подействовали. Если пришельцев тут и не ждали, то быстро оценили и сочли не опасными, да что там, своими их сочли."
    ...
    dreamgirl "Виола же, справившись с карманом халата, достала оттуда непонятную металлическую коробочку, украшенную телефонным диском, и подкинула её в руке."
    show cs smile at left with moveinleft
    cs "Ещё раз «Церновну» услышу, запущу тебе в лоб вот этой штукой."
    dreamgirl "И, убирая уже «эту штуку» обратно в карман, обратила, наконец, внимание на девушку."
    show d_us shy sport at right with moveinright:
        ypos -0.05
    dreamgirl "Подняла бровь, в своём стиле, быстро, но цепко оглядела с головы до ног, углядела кольцо на пальце, бросила взгляд на руку парня, подняла бровь ещё выше, кажется захотела что-то сказать фирменное, но сказала только."
    ...
    show d_to normal pioneer with pixellate
    dreamgirl "И воздух вокруг Толика опять замерцал, искажая и изменяя его облик. Да таким изменённым и оставил."
    dreamgirl "И, кажется, с сегодняшнего дня Толика следовало называть Анатолий"
    hide d_to with moveoutleft
    show cs shy with dspr
    dreamgirl "А парню, похоже, удалось пробить защиту Виолы, потому что она, вернув бровь на место, только кивнула головой и скомандовала."
    ...
    dreamgirl "И дверь в медпункт закрылась, в бесполезной попытке отсечь Ульянку-младшую от тайн и приключений."
    stop ambience
...
label d_comission:
    ...
    dreamgirl "Алиса же при виде гостей замерла. Долго смотрела на них, бормоча что-то себе под нос. А потом вышла, позабыв о планах."
    play sound dct_sfx_chair
    show dv surprise pioneer close with move:
        ypos 0
    show dv surprise pioneer with dspr
    hide dv with moveoutright
    dreamgirl "Виола что-то сказала вожатой, та покивала и разрешающе махнула рукой в сторону столов — садитесь."
    ...
    dreamgirl "Вот, что хорошо в вожатой, так это её принцип: «Наказан — прощён»."
    dreamgirl "Поэтому, когда Ульяна поймала её с вопросом, на выходе из столовой, Ольга Дмитриевна не стала вредничать."
    ...
    dreamgirl "Виола говорила, обращаясь больше к Семёну."
    ...
    dreamgirl "Ульянка мало что понимала, но слушать было интересно. Она выпрямилась, делая вид, что устала и тут перехватила взгляд своей старшей тёзки."
    th "Всё, сейчас выгонят, чтобы не подслушивала."
    dreamgirl "Это было бы обидно, если бы Ульяна-большая вдруг не поднялась с места, опираясь на плечо Семёна, и не подошла к младшей."
    ...
    scene ext_dining_hall_near_day
    play ambience ambience_camp_center_day
    dreamgirl "Через двадцать минут обе Ульяны стояли на крыльце столовой и болтали, не забывая при этом таскать из кулька конфеты. Несмотря на разницу в возрасте, Ульяна-большая оказалась очень свойским и понятливым человеком."
    dreamgirl "Порой, казалось, что она знала, о чем её спросят, раньше, чем собеседница формулировала вопрос, порой Ульяна-маленькая угадывала реплики гостьи. Только иногда гостья замирала, будто вспоминая что-то неприятное, и отвечала так, будто это неприятное в своих ответах обходила."
    ...
    $ renpy.pause (1)
    show d_us normal sport with dspr
    dreamgirl "Тут гостья на мгновение помрачнела, а Ульянка сделала вид, что не заметила."
    us "А уйдёте когда?"
    ...
    with dspr
    us "Я, Ольдмитревна, в столовой все убрала, а сейчас гостье лагерь показываю."
    show mt grin panama pioneer with dspr
    mt "И, конечно, не бесплатно."
    show d_us hurt sport with dspr
    $ renpy.pause (1)
    show d_us normal sport with dspr
    dreamgirl "А Ульяна-большая, увидев вожатую, даже зажмурилась. Потом открыла глаза и, Ульяне-маленькой показалось, что та ответила пересиливая себя."
    ...
    show d_us smile sport with dspr
    us_old "Мы близнецы."
    dreamgirl "И близнецы отправились покорять лагерь."
    stop ambience
    ...
    with dissolve
    play ambience ambience_forest_day
    us "Нет, Мику девочка хорошая, ты не подумай ничего, но сейчас мы бы застряли у нее. Сначала бы она рассказала, что у нее только мама японка, потом…"
    stop music fadeout 3
    ...
    dreamgirl "Так и обходили лагерь по кругу, пока не добрались до медпункта."
    dreamgirl "А пока обходили младшая замечала странности в поведении старшей, когда та, встречая кого-то, сначала улыбалась, как старому знакомому, а потом разочарованно вздыхала, когда этот кто-то ведёт себя так, будто старшую в первый раз видит."
    dreamgirl "Или, когда старшая, войдя в домик, погладила «Весёлого Роджера», как будто домой к себе вернулась, после долгого отсутствия."
    dreamgirl "Вот и родилось у Ульяны-младшей решение."
    show us normal sport with pixellate
    ...
    dreamgirl "В медпункте старшая достала из рюкзака купальник и потрогала бухту верёвки, висящую на рюкзаке."
    ...
    us "Ну, э…"
    hide us with dspr
    dreamgirl "Младшая задумчиво покосилась на Виолу, читавшую какую-то рукопись, наверное, то самое письмо, о котором рассказала гостья."
    show cs normal glasses with dspr
    cs "Я вас не слышу, близнецы."
    dreamgirl "Виола отреагировала, не отрываясь от чтения."
    ...
    show d_us smile sport at center:
        ypos -0.05
    with dspr
    us_old "Понятно все. Пойдём, я лучше тебе другое место покажу."
    show d_us normal sport with dspr:
        ypos -0.05
...
label d_lake:
    ...
    scene ext_path_day with dissolve:
        walking
    dreamgirl "Отказываться Алиса не стала, подзатыльник Ульянке пообещала дать позже, и через десять минут трое Рыжих уже шагали в сторону Старого лагеря."
    ...
    scene dct_ext_old_building_day with moveinright
    show d_us normal sport at center with dspr:
        ypos -0.05
    ...
    th "Вот, кстати, о старом лагере. Столько легенд и страшилок, о той же Чёрной вожатой, например, а так туда и не выбрались до сих пор. Все другие занятия находятся."
    ...
    show d_us normal sport at center with moveinright:
        ypos -0.05
    us_old "Только имейте в виду, ничего там нет. Одна, как говорит мой Семка, мерзость запустения."
    hide d_us with moveoutright
    dreamgirl "И, петляя между деревьями, троица пошла одной только Ульяне-большой известной дорожкой."
    stop ambience
    
    scene dct_ext_lake_day with dissolve
    play ambience ambience_forest_day
    play music music_list["raindrops"] fadein 2
    dreamgirl "Озеро Ульянке понравилось."
    dreamgirl "Прямо посреди леса расположилось круглое блюдце чистой воды."
    dreamgirl "Небольшое, можно обойти по берегу за пять минут, со всех сторон окружённое лесом и только со стороны обращённой к далёкому «Совёнку» есть полянка, отгороженная от воды кустарником."
    dreamgirl "Там же, со стороны поляны, и удобный выход к воде по тропинке через кусты."
    dreamgirl "На поляну кто-то, ещё неизвестно в какие времена, притащил три бревна и положил их треугольником, в центре которого угадывалось давнее кострище."
    ...
    dreamgirl "Да, на озере было тихо, не считая того момента, когда кто-то ломанулся от девушек через кусты. Или зверь средних размеров или крупная птица."
    ...
    dreamgirl "Старый лагерь, куда завернули на обратном пути, разочаровал."
    ...
    dreamgirl "И Ульяна-большая опять погрустнела."
    show d_us hurt sport with dspr
    ...
    us_old "Нормально все, сестрёнка. Я просто поняла, как же далеко я от вас уже ушла."
    show d_us smile sport with dspr
    ...
    dreamgirl "И еле слышимый на таком расстоянии сигнал горна подтвердил, что да, если девочки не хотят остаться голодными, то надо бежать."
    stop sound
    stop ambience
    ...
    play ambience ambience_old_camp_outside
    dreamgirl "Рыжие хохоча ссыпались с крыльца и, где шагом, а где действительно бегом, не оглядываясь, заспешили на ужин."
    dreamgirl "Некоторое время ещё мелькали их спины: две в красных футболках и одна в пионерской рубашке, а потом деревья заслонили девушек окончательно."
    stop ambience
    ...
    scene ext_dining_hall_away_day with dissolve
    play ambience ambience_camp_center_day
    dreamgirl "Перед столовой шуточная перепалка между гостями закончилась, и Семён поведал новость."
    ...
    play ambience ambience_dining_hall_full
    dreamgirl "Вся четвёрка разделилась уже в столовой: Ульяна-младшая и Алиса пошли к своему отряду, а гости — за стол администрации. Ульянка ещё услышала, как Виола произнесла, обращаясь к Семёну:"
    show d_sf normal pioneer at left:
        zoom 0.8
    ...
    dv "Нет-нет, мне они тоже понравились, но вот ещё, не знаю как ты, а я все время пытаюсь понять, где я этого Семёна могла видеть?"
    ...
    stop music fadeout 3
    dreamgirl "Ужин давно закончился, Рыжие сидели в кустах за своим домиком и перебирали странности сегодняшних гостей, когда к ним присоединилась Ульяна-большая."
    show d_us normal sport at center with dspr:
        ypos -0.05
    us_old "Девочки, можно с вами?"
    show d_us sad sport with dspr
    us_old "А то Виола сейчас в спину Семке вот такие здоровенные иглы навтыкала вдоль всего позвоночника."
    ...
    show d_us hurt sport with dspr
    us_old "Никогда не думала, что я такая чувствительная. Кнопку на стул подложить — легко, паука в руки взять — вообще, как котёнка погладить, кого другого булавкой тыкать — пожалуйста, но Семку, оказывается, жалко."
    show us surp2 pioneer with dspr
    ...
    dreamgirl "Рыжие туземки помолчали сочувственно, а Ульяна-большая, успокоившись уже, добавила."
    us_old "Спасибо вам. Выговорилась, так легче стало. Если надо учиться — буду учиться."
    show d_us smile sport with dspr
    dreamgirl "А потом посмотрела на Ульяну-младшую, на Алису, которые все порывались открыть рот и спросить, например, о странностях в поведении некоторых гостей лагеря, улыбнулась своим мыслям и предложила сама."
    show us normal pioneer with dspr
    us_old "Спрашивайте. Семка ворчать будет, может и Виола ругаться будет, но спрашивайте."
    show dv guilty pioneer with dspr
    dreamgirl "И вышло так, что Ульяна с Алисой не смогли озвучить всю ту кучу вопросов, что накопилась за эти полдня в их головах, просто язык не повернулся."
    show us dontlike pioneer with dspr
    dreamgirl "Ульяна даже отвернулась от досады, чтобы не смотреть на гостью."
    dreamgirl "А Ульяна-большая ещё раз глянула на девушек, вздохнула, поднялась на ноги и прощаясь сказала больше самой себе."
    show d_us sad sport with dspr
    ...
    hide d_us with dspr
    dreamgirl "И ушла вызволять Сёму из лап медицины."
    stop ambience
    ...
    dreamgirl "{i}Семён, Виола и Анатолий сидели в медпункте, тут же, на столе, стояла литровая химическая склянка коричневого стекла и три маленьких, на пятьдесят миллилитров, лабораторных стакана.{/i}"
    me "А баба Глаша?"
    show cs normal glasses with dspr
    ...
    hide d_sf
    with moveoutright
    dreamgirl "Почему-то теперь, после того, как удалось вытащить из Виолы человека, она перестала пугать."
    stop music fadeout 1
    stop ambience
...
label d_persunovs:
    ...
    dreamgirl "Гости неспешно шли по тропинке от медпункта к спортзалу и делились впечатлениями о прошедшем дне."
    show d_us smile sport with dspr
    ...
    me "Знаешь, Уля, с вами, Рыжими, у меня почему-то всегда были хорошие отношения. Во всех узлах. И, вот я вернулся в родной лагерь, с которого у меня все начиналось. И не пионер, а, вроде как, один из… Один из не знаю кого, из местного начальства, что ли, явного и тайного, но вот оказалось, что девочки мне ближе, мне с ними легче, чем с вожатой, с Виолой, с Толиком."
    stop sound_loop
    stop ambience
    ...
    dreamgirl "Ульяна долго молчала, не решаясь спросить, а Семён терпеливо ждал. И только в спортзале, разговор возобновился."
    show d_us normal sport at right:
        ypos -0.05
    show d_sf normal pioneer at left
    with dspr
    ...
    show d_us sad sport with dspr
    me "Уля. Я очень хочу, чтобы было. Но я не помню, вот в чем беда."
    me "Я знаю, что было, я уверен, что было, но то, что я помню, это или как черно-белые фотографии в чужом альбоме, или же сухие факты, как в протоколе, или сон, где все перемешано и невозможно его толком описать."
    ...
    me "Ну, а про те циклы, которые я уже помню, ты про них все знаешь, повторяться не буду."
    show d_us normal sport with dspr:
    us_old "Да, знаю, Сем. Я почему спросила. Помнишь ты днём про здешнюю Лену сказал, а перед ужином ещё про Славю?"
    us_old "Я ревновать пыталась, честно. Не получилось. А сейчас, когда познакомилась с девочками здешними, и вовсе не получится."
    us_old "Потому что, если бы не эти девочки, ты бы не стал таким, каким ты есть, какого я люблю, понимаешь?"
    ...
    us_old "Ты, конечно, пропустил все, что тебе подарили, через свою личность и все изменил под себя, но они, эти черты, есть и никуда не делись, и я их вдруг увидела, что-то от Алисы, от Лены, от Мику, понимаешь?"
    ...
    show blink
    dreamgirl "Ульяна прижалась к Сёмке, спрятав лицо на его груди."
    us_old "Семка, я совсем не ревнивая и совсем не дура, да?"
    us_old "Я все боялась, что за те пять циклов, за десять недель, после твоего возвращения, повзрослела физически на пять лет, а сама осталась той же четырнадцатилетней дурочкой, понимаешь?"
    "А Семка только прижимал Ульяну к себе, целовал в макушку и глупо улыбался."
    me "Рыжик мой, все хорошо. Ты такая, какая есть и именно такая, какая мне нужна. А когда ты меняешься, то становишься нужна такая, какая становишься."
    ...
    me "Вот и пытаешься все понять и все запомнить, чтобы хоть что-то осталось. А ты не бойся, ты, когда опять проснёшься, все вспомнишь. А если не вспомнишь, то я тебе напомню, обещаю. И пока ты спишь, тоже напоминать буду, каждый день, в каждом цикле."
    ...
    dreamgirl "И эта шутливая разрядка после момента откровения, продолжалась бы ещё, если бы дверь в тренерскую не открылась и в комнату не заглянули."
    stop music fadeout 1
    stop ambience
    ...
    $ persistent.sprite_time = "sunset"
    play ambience ambience_camp_center_evening
    dreamgirl "Алиса долго сомневалась, откликаться или нет на приглашение Ульяны-большой. Если бы компания ограничилась только двумя Ульянами, то пошла бы не задумываясь: Ульяна-большая ей нравилась, даже несмотря на недавний неловкий момент, но Семён был личностью непонятной."
    ...
    dv "Да, есть немного. Сегодня, когда вечером встретились на площади, он так улыбнулся как старой знакомой. И потом, пока к столовой шли, все поглядывал на нас. Поглядит — улыбнётся, поглядит — улыбнётся, как будто убеждался, что все у нас хорошо. Или вот это вот чувство, что мы обе его знаем."
    ...
    play ambience ambience_camp_center_evening
    play sound_loop dct_sfx_steps2
    dreamgirl "Пошла конечно. И люди интересные, и чтобы самой себе, Семёну и Ульяне-большой доказать, что никого не стесняется."
    th "Какой же вопрос гостям задать и не опозориться, как два часа назад с Ульяной?"
    dreamgirl "Ведь хотелось же спросить о многом, и Ульяна-большая разрешила и даже сама попросила задавать вопросы — как будто стыдно стало спрашивать, и язык не повернулся."
    ...
    with hpunch
    us "Нет, она не одна!"
    dreamgirl "Ульянка, все-таки догнавшая Алису, протиснулась мимо неё в тренерскую и по-хозяйски огляделась."
    ...
    dreamgirl "Почему-то гости лагеря переглянулись при этих словах, Ульяна-большая непонятно хмыкнула, а Семён тихо пробурчал что-то, кажется опять про сходимость."
    show d_us normal sport with dissolve
    us_old "Девочки, чтобы не было вопросов, почему мы вас пригласили — нипочему."
    show d_sf serious pioneer with dspr
    us_old "Сёмка молчит, но ему было важно убедиться, что все здесь в порядке. И не морщись, Сём, так оно и есть, сам же меня врать отучил."
...
label mediocris_fabula:
    ...
    me "Уля, ты не…"
    hide d_sf with dspr
    us_old "Семка, не мешайся, и вообще, не путайся под ногами, это моя сказка, а не твоя. Ты ту свою, которую на острове начал рассказывать, так и не закончил, а ведь Гришка все ещё ждёт продолжения. Хорошо, что он маленький и для него все в одно бесконечное лето сливается, а то давно бы плюнул и ждать перестал."
    us_old "Ну и отличался наш пионер от остальных-прочих, а чем — потом расскажу."
    us_old "Много с ним всякого за эту неделю происходило, но всегда, в каждый его заезд, все, как будто повторялось. Начинал с того, что, как положено, с обходным бегал, с пионерами знакомился: с кем-то так: привет-привет, пока-пока; с кем-то ближе; с кем-то совсем близко."
    us_old "И каждый раз думал, что вот смена закончится, он друзей-то не потеряет. А смена заканчивалась, он домой приезжал, и оказывалось, что все это сон и что пионеру тому, на самом деле, двадцать семь лет, семьи у него нет, любимой девушки нет, друзей нет, любимой работы нет, интересов никаких нет, — просто одна тоска безрадостная."
    ...
    us_old "Как звали? Не важно, пусть будет Степан."
    us_old "Так вот…"
    $ set_mode_nvl ()
    hide dv
    hide us
    ...
    hide d_sf with dspr
    us_old "Да Сем, спасибо, «очевидные причинно-следственные связи», именно так."
    ...
    with dissolve
    $ set_mode_adv ()
    us_old "Сем, если тяжело сидеть, ты ложись. Мы не обидимся."
    ...
    hide d_us
    with dissolve
    "{i}А тот пионер, он разворошит лагерь и хорошо ему, потому что видит, что и люди вокруг, оказывается, живые, и сам он живой, а не кукла и не сумасшедший.\nС кем-то подружится, в какую-то девочку влюбится, какая-то в него влюбится. Он, может, потому и понял все про себя, что все, что человеческого от пионеров получал, он в себя впитывал и сам изменялся, может быть, просто случайно, может, по недосмотру программы.\nА когда изменений много накопилось, он и стал отличаться от того пионера, для которого программа была записана и начал помнить про себя все.{/i}"
    show dv normal pioneer at left
    show us normal sport at cleft
    show d_us normal sport at right:
        ypos -0.05
    ...
    show us grin sport with dspr
    us "Всё-всё понятно. А что не понятно, то спросим. Ты рассказывай, сестрёнка."
    show us normal sport with dspr
    us_old "Хорошо."
    us_old "Вот только плохо Степану бывало уже потом, когда старый цикл заканчивался, а новый начинался."
    show us surp1 sport with dspr
    us "Что ещё за цикл?"
    us_old "Цикл? Да, он, сестрёнка, смены циклами стал называть, потому что все по кругу ходило."
    show us normal sport with dspr
    ...
    hide d_us
    with dissolve
    "{i}Приезжает он в лагерь, а там все по прежнему и никто его не помнит, даже та, с кем в любви друг-другу клялись — смотрит на него и не узнает и надо все с начала начинать.\nНачинает с начала, а результат другой: с кем неделю назад дружил, с тем сегодня поссорился, кто тебе жуков в ботинки подбрасывал — тебе в глаза заглядывает и каждое слово ловит, потому что живые же люди и С… Степан, и те, что вокруг него, они не могут каждый раз жить одинаково.\nА на следующий цикл опять надо по полной выкладываться, чтобы до пионеров достучаться, потому что если просто сидеть и ничего не делать, то все пионеры и ведут себя как куклы, а так, из цикла в цикл, в окружении кукол, с ума можно сойти.\nНекоторые и сходили.{/i}"
    show dv normal pioneer at left
    show us normal sport at cleft
    show d_us normal sport at right:
        ypos -0.05
    ...
    me "…"
    hide d_sf with dspr
    us_old "Молчи, Семка, не говори ничего."
    ...
    us_old "А зачем, Алиса? Все равно не напечатают. Я же так, для себя и для вас, на ходу сочинила."
    show dv shy pioneer with dspr
    ...
    #Нет, Ольга о нем не должна знать, все может быть, конечно, но вряд ли она знает. Вот Виола и Анатолий — те, наверное, знают, но туда не ходят и болтать не будут». 
    ...
    show us normal sport at left
    with dissolve
    dreamgirl "Где-то через час после отбоя, Рыжие возвращались к себе."
    ...
    with moveoutleft
    stop sound_loop
    dreamgirl "Тут девочки одновременно остановились и одновременно же сделали шаг в сторону ближайших кустов, куда не добивал свет от фонарей, чтобы пропустить совершающую вечерний обход Ольгу Дмитриевну."
    show mt normal panama pioneer with moveinright
    $ renpy.pause (0.5)
    hide mt with moveoutright
    dreamgirl "Ольга подошла к спортзалу, постояла на крыльце, занеся руку и собираясь постучаться, но передумала и пошла дальше, к хозяйственным воротам, чтобы оттуда свернуть к пляжу."
    ...
    show dv normal pioneer at left
    with dissolve
    us "Алис, а я все о сказке этой думаю. Как ты думаешь, о ком она?"
    show dv surprise pioneer with dspr
    ...
    stop ambience
    $ renpy.pause (0.5)
    dreamgirl "День, богатый неожиданными событиями, закончился. Девочки добрались до домика, взяли полотенца и убежали к умывальнику. Нужно было успеть умыться, вернуться и залечь в кровати."
    dreamgirl "Скоро мимо их домика должна была пройти вожатая, и выслушивать порцию воплей совершенно не хотелось, не хотелось портить впечатление от, в целом, неплохого дня."
...
label insomnia:
    ...
    $ persistent.sprite_time = "night"
    play ambience ambience_int_cabin_night
    dreamgirl "Алисе не спалось — слишком много впечатлений она получила за прошедший день."
    dreamgirl "Стоило закрыть глаза, как начинал сниться один и тот же сон — она и Мику учат Семёна играть на гитаре."
    stop ambience
    ...
    with squares
    play ambience ambience_camp_center_day
    dreamgirl "Потом Мику исчезает, а Алиса с Семёном переносятся на эстраду, где вдвоём подбирают какую-то песню."
    me "Ну может ты хоть это слышала?"
    dv "Сенька, сознавайся, откуда ты это всё притащил?"
    show d_sm normal pioneer with dspr
    me "Сознаться? Но ты же все равно не поверишь."
    dreamgirl "Почему-то Семён из сна — её ровесник. Он опоздал к началу смены, а сегодня попросил у Мику гитару, ушёл на концертную площадку и кажется не собирается идти на дискотеку."
    play music music_list["orchid"] fadein 3
    dreamgirl "Но это, несомненно, тот самый Семён, который сегодня пришёл в лагерь, которому Виола лечила спину и который угощал их вечером чаем с домашним печеньем."
    show d_sm sad pioneer with dspr
    me "Слушай тогда. Может хоть на этот раз…"
    dreamgirl "Во сне этот Семён каждый раз собирается рассказать Алисе что-то важное, уже открывает рот, но в самый последний момент, Алиса всегда просыпается."
    stop music fadeout 1
    stop ambience
    ...
    th "Все равно не усну — пойду поиграю."
    stop sound
    stop ambience
    ...
    play ambience ambience_int_cabin_night
    dreamgirl "Пять минут спустя, когда Алиса кралась, огибая по периметру площадь, проснулась Ульяна."
    us "Алиска."
    stop ambience
    
    scene ext_boathouse_day with pixellate
    $ prolog_time ()
    $ persistent.sprite_time = "day"
    play music music_list["door_to_nightmare"] 
    dreamgirl "Ульяне тоже снился сон, и тоже с участием Семёна. Снилось Ульяне, что она стоит на берегу и смотрит на лодку, добравшуюся уже до середины протоки."
    ...
    hide dv with moveoutleft
    dreamgirl "А Ульяна сначала прыгает на месте от избытка эмоций, и машет Семёну обеими руками, как спортсмену на стадионе, а потом прекращает прыгать, опускает левую руку, а правой машет все медленнее и, наконец, замирает встав на цыпочки, с поднятой правой рукой, прощаясь."
    dreamgirl "И на душе, там, во сне, становится одновременно и радостно за Семёна, потому что уже ясно, что все у него получится; и грустно, что он уплывает; и обидно, что не позвал с собой и даже не попрощался."
    dreamgirl "С этим ощущением радости-грусти-обиды Ульяна-младшая и проснулась."
    stop music fadeout 1
    ...
    us "Алиска." 
    us "Алиска. Ты спишь?"
    dreamgirl "Ульяна ничего не боялась. Ничего. Но она старалась никогда-никогда не оставаться ночью одна в домике. Сразу вспоминались все те страшные истории, которыми она любила пугать октябрят из младшего отряда, и в каждой тени, в каждом тёмном углу чудился кто-то из персонажей этих историй."
    dreamgirl "Ульянке бы встать, добежать до выключателя и зажечь свет, но не хватало храбрости выбраться из-под одеяла."
    th "Ушла. Страшно то как одной."
    th "Ничего, я сейчас."
    show blink
    dreamgirl "Наконец, когда на борьбу со страхом не осталось никаких сил, Ульянка вскочила и зажмурившись схватила со стула одежду и побежала к выходу."
    stop ambience
    ...
    with dissolve
    play ambience ambience_camp_center_night
    dreamgirl "И мгновенно стало спокойнее, и страх сразу куда-то ушёл. Девочка ещё постояла, приходя в себя и осматриваясь в поисках Алисы."
    show us normal sport with dspr
    play sound dct_sfx_apple
    th "Кто шумит? Алиска? За домиком сидит? Песню сочиняет?"
    dreamgirl "За домиком шуршали кусты, и Ульянка, всунув ноги в стоявшие тут же на крыльце сандалии, крадучись пошла в обход."
    show us grin sport with dspr
    ...
    play ambience ambience_camp_center_night
    dreamgirl "Анатолий с Виолой тоже не спали, правда, никакие необычные сны их не тревожили.\nПоследние, не считая Шурика, люди-подлинники вспоминали."
    dreamgirl "Вспоминали закрытие проекта, вспоминали посёлок Шлюз, вспоминали Денисовну, которую видели последний раз лет десять назад, когда удалось созвониться, удалось договориться о встрече, и последние люди, сохранявшие память, собрались, в ночь между циклами, на автобусной остановке у ворот посёлка."
    dreamgirl "А ещё не давало уснуть письмо Глафиры Денисовны. По словам Семёна, пакет с письмом ему было вручён за один цикл до смерти профессора Андрейко."
    stop ambience
    ...
    $ persistent.sprite_time = "night"
    play ambience ambience_camp_center_night
    dreamgirl "А через две недели Глафира Денисовна ушла, и первый настоящий переход между узлами Персуновы совершили по печальному поводу."
    dreamgirl "А завтра нужно было ещё раз, уже внимательно, перечитать письмо, в той его части, которая касалась Сети лагерей. Изучить содержимое общих тетрадей, проверить обоснованность содержащихся там выводов, и уже тогда принимать решение."
    dreamgirl "Кстати, нужно было показать это письмо ещё и Семёну, тем более, что там была пара абзацев обращенных к нему лично."
    stop ambience
    ...
    dreamgirl "Свет в медпункте погас, и оба обитателя, не беспокоясь больше ни о чём, проспали до самого подъёма. Их ждало пять общих тетрадей, исписанных от корки до корки, и у них было трое с половиной суток на прочтение и принятие решения."
    stop ambience
    ...
    dreamgirl "А Алиса вдруг, неожиданно для себя, спросила Семёна о том, что мучило её с самого обеда."
    show 3500_dv shy casual with dspr
    dv "Послушай, Семён. Где я тебя видела?"
    dreamgirl "И что-то внутри Алисы оборвалось от её собственного вопроса."
    ...
    show d_us normal dress at cright:
        ypos -0.05
    show d_sf serious hike at cleft with dspr
    $ renpy.pause (3)
    hide blink
    show unblink
    us_old "Алиса, все хорошо. Сейчас мы тебя к Виоле отведём."
    dv "Чт-то эт-то так-кое был-ло?"
    me "А что именно было?"
    dv "Т-ты сказал мне про лодку. И я вдруг увидела это все, как будто вспомнила. И после этого мне стало плохо."
    me "Не знаю."
    us_old "Алис, ты идти сможешь?"
    show 3500_dv normal casual with dspr
    dv "К Виоле? Нет-уж, нет-уж."
    dreamgirl "Алиса постепенно приходила в себя."
    ...
    show d_sf laugh hike with dspr
    show d_us smile dress with dspr
    dreamgirl "Да, Алиса пришла в себя."
    ...
    with dspr
    play ambience ambience_camp_center_night
    dreamgirl "Семён и Ульяна уже уходили с площадки, когда Алиса неожиданно для самой себя позвала."
    dv "Семён!"
    ...
    play ambience ambience_camp_center_night
    dreamgirl "Алиса, оставшись одна, попробовала поиграть, но, после непонятного приступа, ничего толкового не получалось. Несколько раз пробовала — бесполезно. Перед глазами стояла описанная Семёном сцена, и всплывали подробности, о которых Семён не упоминал."
    stop ambience
    ...
    mt "Славя, отвязывай лодку! Сыроежкин, бей окно в сарае и доставай весла!"
    ...
    play ambience ambience_camp_center_night
    play sound_loop dct_sfx_steps3
    dreamgirl "Пока шла домой, показалось, как кто-то побежал от домика в сторону забора."
    show 3500_dv shocked casual with dspr
    ...
    dreamgirl "Ульяна всегда делала вид, что ничего не боится, а Алиса — что ничего не знает об Ульянкиных страхах, только старалась не оставлять её одну. Но не всегда получалось, вот как сегодня."
    us "Нет, не очень. Как песня?"
    dv "Никак — надо ещё работать. Давай спать."
    us "Давай."
    show blink
    stop ambience
    dreamgirl "И последние обитатели лагеря наконец-то угомонились. До подъёма оставалось чуть больше пяти часов."
...
label last_letter:
    ...
    play ambience ambience_int_cabin_day
    play music music_list["i_want_to_play"]
    dreamgirl "Вожатая только что вернулась от умывальников, и сейчас, все ещё дрожа от ледяной воды, переодевалась из спортивного костюма в форму."
    dreamgirl "Несмотря на запрограммированную привычку следовать нормам, уставам и правилам распорядка, Ольга этими правилами тяготилась, и находила отдушину в мелкой бытовой лени и раздолбайстве."
    dreamgirl "Потому и спортивный костюм, и повседневная форма, и ночная рубашка, вместо того, чтобы висеть в шкафу, лежали сейчас рядком на свободной кровати."
    ...
    th "Если не забуду."
    hide mt with moveoutright
    dreamgirl "Ольга Дмитриевна ещё раз поправила галстук и, улыбнувшись возвращающейся с пробежки Славе, отправилась к спорткомплексу."
    stop ambience
    ...
    play ambience ambience_camp_center_day
    play music music_list["timid_girl"]
    dreamgirl "По счастью, будить никого не пришлось."
    dreamgirl "И Семён, и Ульяна-большая (вот прижилось же в лагере, в первые же часы пребывания гостей: Ульяна-большая и Ульяна-маленькая) стояли на улице и, судя по всему, только что пришли с пляжа."
    ...
    me "Все понятно, придем. И, спасибо, что приютили нас."
    ...
    dreamgirl "Тридцать минут спустя Семён и Ульяна-большая были представлены лагерю."
    dreamgirl "К счастью, про «экологов» никто не вспомнил, а то Семён уже мысленно чертыхался и ругал фантазию Виолы, представляя, как он мямлит что-то, собирающейся, вроде бы, стать экологом Славе."
    dreamgirl "Правда был ещё и запасной вариант — просто сказать Славе, что никакого «завтра» у неё нет и не будет, а есть только вечные две недели, и если она не начнёт меняться внутри себя, то так в этих четырнадцати днях и останется запертой."
    stop music
    stop ambience
    ...
    nvl clear
    "{i}Уже давно мне кажется, что мы сделали что-то не то, свернули не туда, но раньше это было где-то на уровне интуиции и не оформившихся сомнений, а сейчас это уже на уровне уверенности — я все же не зря прожила здесь эти двадцать лет — по крайней мере, никто не отвлекал от работы.\nВся наша возня здесь, это цепочка ошибок, начиная с самой первой — образца пятьдесят шестого года, когда, прикрываясь испытанием водородной бомбы, мы создали пространственную вакуоль.\nБудущий нулевой узел, будущий посёлок Шлюз.{/i}"
    ...
    dreamgirl "Семён аккуратно спрятал письмо в конверт, конверт спрятал в журнал — тот самый — «Советская модница» и, через спортзал, отправился в столовую."
    hide d_sf with moveoutright
    stop ambience
    ...
    with dissolve
    play ambience ambience_camp_center_day
    dreamgirl "Пока шёл — раскланивался направо и налево — вот и плюс от посещения линейки. Потому что в первый день очень хотелось с каждым встречным поздороваться, а фактически выходило что этот встречный — совсем не знакомый пионер."
    dreamgirl "Не напоминать же, что уже познакомился с ним много-много циклов тому назад — не поймёт."
    stop ambience
    ...
    dreamgirl "Алиса кивнула прошедшему мимо Семёну."
    show dv normal pioneer with dspr
    ...
    dreamgirl "На самом деле Алиса так не считала, но как иначе, чем гипнозом, было объяснить продолжающееся с прошедшей ночи буйство воображения?"
    dreamgirl "Со вчерашнего вечера в голове всплывали картины и образы, странно связанные со вчерашней репликой Семёна про пристань, лодку и двадцать гребков в минуту."
    stop ambience
    ...
    play ambience ambience_camp_center_day
    show dv shocked pioneer with dspr
    dreamgirl "А дальше вспоминался след от волочения лодки на песчаной стрелке острова; разбросанные инструменты, обрезки верёвки, щепки; и неожиданно красиво идущая, под светло-голубым самодельным парусом, лодка."
    stop music fadeout 2
    dreamgirl "И Семён, нет — Сенька, сидящий на планшире наветренного борта, лицом к выскочившей на берег погоне, и, все-таки, поднявший на прощание левую руку, совершенно искренне, без всякой издёвки, поднявший."
    dreamgirl "А ещё, почему-то представлялся импровизированный концерт и сорванная этим концертом дискотека, и они вдвоём, нет втроём — ещё Мику, на сцене."
    dv "Гипнотизёр чёртов!"
    hide dv
    ...
    hide us
    with moveoutright
    dreamgirl "На том порешили, успокоились, и отправились завтракать."
    stop ambience
    
    scene int_dining_hall_people_day with dissolve
    play ambience ambience_dining_hall_full
    dreamgirl "Но в столовой обе девочки вспомнили о своих делах, похоронив утренние планы."
    ...
    with dissolve
    dreamgirl "Мику за завтраком постоянно поглядывала на гостей."
    ...
    dreamgirl "{i}Нет, это была не та Мику, что однажды купалась с Семёном на дальнем берегу острова. Да и от той Мику не осталось практически ничего — душа, которую в здешних терминах называли «неуничтожимым ядром личности» и оболочка.{/i}"
    dreamgirl "{i}Но не могла та их встреча с Семёном, тот выплеск чувств, пройти бесследно: как всем Алисам снилась одна и та же песня, так и уменьшительно-ласкательное «Сенечка» расползлось по всем узлам сети.{/i}"
    stop ambience
    ...
    show d_sf laugh pioneer with dspr
    dreamgirl "А Семён только слушал, кивал и улыбался чему-то своему."
    show d_sf smile pioneer with dspr
    dreamgirl "Наконец у Мику кончился запас воздуха в лёгких и это позволило Семёну вклиниться в монолог."
    me "Здравствуй, Мику. А я гитару попросить зашёл. В долг до воскресения."
    ...
    stop music fadeout 1
    dreamgirl "Мику перемещалась по кружку словно перепархивая с места на место. И перепархивания эти, при всей своей хаотичности, имели цель и завершились возле трёх, одинаковых с виду, инструментов."
    dreamgirl "Мику, поводив пальцем над прислонёнными к стене гитарами, остановилась на крайней левой, взяла её в руки, провела по струнам, удовлетворённо кивнула и вручила Семёну."
    ...
    dreamgirl "Жаль, что Алиса уже успела уйти, потому что она бы сразу взяла Семёна в оборот, напомнив про ночное обещание обязательно сыграть. А Мику просто стояла и смотрела, как Семён присел на табуретку, как взял несколько аккордов (тут Мику просто впилась в Семёна глазами), чтобы послушать, как звучит инструмент."
    show mi surprise pioneer with dspr
    dreamgirl "И тут Семён перехватил взгляд Мику."
    show d_sf serious pioneer with dspr
    ...
    play music anewbeginning fadein 2
    me "Поэтому песня тоже будет не весёлая. Мелодию ты знаешь, а слова — может быть тоже." 
    dreamgirl "Голос у Семёна оказался тихий, глуховатый и Семён еле заметно картавил, что, правда, нисколько не испортило исполнение."
    show mi shocked pioneer with dspr
    $ renpy.pause (1)
    show mi normal pioneer with dspr
    dreamgirl "А Мику, со второй строчки поняла, что да, она знает эту песню и даже сама когда-то, неизвестно когда, но исполняла её, именно на здешней сцене. Мику не смогла удержаться и, поймав взгляд Семёна, умоляюще посмотрела, дождалась его кивка, и второй куплет пела уже она."
    ...
    $ renpy.pause (0.5)
    show dv normal pioneer with dspr
    dreamgirl "Всё-таки у обоих музыкантов Совёнка было чутье и была интуиция. Потому что, где-то в начале второго куплета, в музыкальный кружок, сама, не зная зачем, вернулась Алиса и история повторилась, и уже новый голос подхватил третий куплет."
    show mi sad pioneer
    show dv sad pioneer
    with dspr
    $ renpy.pause (2)
    dreamgirl "Минутy все молчали, переживая песню."
    ...
    mi "Ой, да можно, конечно. Все равно она тут никому не нужна. Только, Сенеч… Семён, поиграешь ещё? Я все-таки хочу понять, откуда мне твоя манера знакома."
    show d_sf normal pioneer with dspr
    ...
    show dv shocked pioneer with dspr
    dreamgirl "Семён пробурчал тихо, про себя, но Алиса услышала и вздрогнула."
    show dv normal pioneer
    show mi normal pioneer
    show d_sf normal pioneer
    with dspr
    me "Знаешь, Мику. Я не наберу песен на концерт. Но собраться здесь, на веранде, вечером — почему нет. Или отойти подальше и костёр устроить, но лучше, все-таки, собраться на веранде. Сегодня нет, а вот завтра — пожалуйста."
    hide d_sf with moveoutleft
    stop ambience
...
label routine_:
    ...
    th "А здешняя Славя — нет. Славя — хозяйка, ей лагерь как дом, а все пионеры — как младшие братья и сестры. Причём сильно младшие. С которыми возиться не интересно, которыми нужно командовать и которых нужно опекать. А площадь-то она сама лично подметает, просто потому, что в доме должен быть порядок…" 
    ...
    sl "Хорошо — на ты. Я как раз и хотела, чтобы ты помогла мне в спорткомплексе порядок навести, раз уж вы все равно там поселились. Мы вчера с твоим Семёном начали, но не успели закончить."
    ...
    th "Но где ж их взять-то, хороших, да ещё и с признаками совести? Вот Славя такая подрастает, но все, с Сёмкиных времён, никак подрасти не может."
    ...
    dreamgirl "Когда Ульяна разбирала рюкзак — из кармана в клапане выпал Выключатель."
    show d_us hurt sport with dspr
    ...
    dreamgirl "Ульяна достала из своей сумки рабочую тетрадь, ручку, план лагеря и окрестностей, логарифмическую линейку."
    dreamgirl "Надела стеклянный бегунок на древний артефакт. Провела пальцем по надписи выцарапанной под движком: «А.Г.Д.»"
    dreamgirl "Вздохнула, вспомнила бабу Глашу."
    stop music fadeout 1
    stop ambience
    ...
    dreamgirl "На столе лежал журнал мод. «Советская модница», — не то, чтобы у Ульяны очень болела об этом голова, но она все же была девочкой и, отложив в сторону тетрадь, потянулась к журналу."
    th "Спасибо, Сёмка, полистаю."
    play sound dct_sfx_pages
    dreamgirl "Журнал раскрылся, конечно же, на тех страницах, между которыми Семён вложил конверт с письмом. Да, тот самый конверт с письмом бабы Глаши."
    th "Сёмка придёт — спрошу. Баба Глаша не чужой мне человек."
    dreamgirl "Очень давно Ульяна, не задумываясь, схватилась бы за письмо просто так — от любопытства. А сейчас — повертела конверт в руках, потом, пересилив себя, отложила его в сторону и взялась за расчёты. Так и провозилась до полудня, когда пришёл Семён."
    stop ambience
    ...
    me "Ну хоть топать не далеко. Лишь бы твоя сестрёнка не увязалась следить."
    dreamgirl "Так бы и говорили они ни о чём, но Ульяна взяла в руки конверт."
    us_old "Сёмк?"
    me "Да, Уля?"
    ...
    show d_us laugh sport with dspr:
        zoom 0.8
    us_old "Конечно зря, Сёмк. Теперь тебе придётся мне объяснять — кто это такие и чем мы все друг от друга отличаемся. Это и мой мир, и я тоже хочу знать о нем всё. Но ты о письме говорил."
    show d_us smile sport with dspr:
        zoom 0.8
    show d_sf smile pioneer with dspr
    $ renpy.pause (1)
    show d_sf normal pioneer with dspr
    me "В общем, главная мысль в письме та, что наш мир, в котором мы живём, нестабилен. Рано или поздно все здесь может начать сыпаться и, в конце концов, рухнет. Уже признаки есть."
    ...
    dreamgirl "Ульяна-маленькая возвращалась из Старого лагеря очень собою довольная."
    stop sound_loop
    stop ambience
    ...
    dreamgirl "Несмотря на темперамент и детскую ещё нетерпеливость, девочка умела и строить планы, и выполнять их."
    dreamgirl "Вот и сейчас, проведя полдня в Старом лагере и избавившись от украденной ватрушки, яблока и половины кулька конфет, она принесла назад несколько страниц вырванных утром из Алисиной тетради со стихами. Когда-то чистых, а сейчас исчирканных записями, схемами и рисунками."
    dreamgirl "Ещё несколько страниц было оставлено в Старом лагере."
    dreamgirl "А ещё нужно было осмыслить всё это найденное богатство."
    show us normal sport with dspr
    play sound sfx_dinner_jingle_normal
    ...
    th "Приключения приключенями, а обед по расписанию."
    ...
    mi "Жаль, что он так влюблён в свою рыжую. Все время ищет её глазами."
    show mi smile pioneer with dspr
    show un smile pioneer with dspr
    ...
    show mi normal pioneer with dspr
    mi "Знаешь, он, пока был у меня в кружке, все время посматривал на то место, где должна висеть пятая портьера, которой не хватает."
    show mi upset pioneer with dspr
    ...
    with squares
    dreamgirl "Ольга Дмитриевна стояла на крыльце столовой. Кивнула Виоле с подопечным Толиком, улыбнулась гостям — Семёну и Ульяне-большой."
    play ambience ambience_camp_center_day
...
label promenade_:
    ...
    dreamgirl "Вожатая не пошла за столик администрации, а подсела к своей помощнице."
    dreamgirl "Некоторое время обедали молча. Обе: и вожатая и её помощница отсутствием аппетита не страдали, и предпочли сначала утолить первый голод, а потом уже говорить о делах."
    show blinking
    $ renpy.pause (1)
    play music music_list["timid_girl"]
    ...
    dreamgirl "Мику, на своё несчастье, пробегала мимо столовой в тот самый момент, когда оттуда вышла вожатая."
    hide mi
    ...
    hide mt with moveoutleft
    dreamgirl "Ольга Дмитриевна поймала очередную жертву, поставила перед той задачу и ушла, не слушая возражений."
    stop ambience
    ...
    show d_sf serious pioneer with dspr
    dreamgirl "Мнением Семёна девушки не интересовались. А Семён опять вздрогнул. Нет, в его лагере Мику тоже, бывало, звала его Сенечкой, но там Семён к этому привык и не реагировал. А тут каждый раз как будто что-то простреливало в голове. Что-то, что он не успевал отследить."
    dreamgirl "Вот и сейчас. Что-то, какой-то образ мелькнул и исчез."
    ...
    me "В воскресенье после обеда, Мику. Но все равно толком ничего не успеем, а халтурить не хочется…"
    dreamgirl "Семёна после дня Нептуна уже ничего не пугало, а Мику очень обидно было ощущать свою бесполезность в лагере. Так и родился этот диалог."
    us_old "Мику, ты закончила здесь? А то мы помочь можем."
    mi "Нет, ребята, спасибо. Я уже все."
    hide mi with moveoutleft
    dreamgirl "Мику спрятала метлу за гипсового пионера, улыбнулась гостям и упорхала. А гости пошли дальше — мимо клубов на площадь."
    stop ambience
    ...
    me "Разница, конечно, чувствуется, но все равно никогда и нигде ничего, кроме позитивной улыбки, не вызывает. Хотя, это её надо понять и к ней надо привыкнуть."
    ...
    dreamgirl "Персуновы гуляли по лагерю до ужина, повторяя маршруты Семёна, и проходя по памятным ему местам, и под Семёновы же комментарии."
    ...
    dreamgirl "Уже перед дверями спортзала гости столкнулись с уставшей загорать и купаться вожатой."
    ...
    play ambience ambience_int_cabin_day
    dreamgirl "Мику, вернувшись с остановки в домик, достала из чемодана тетрадку, уселась за стол и наморщила лоб."
    play sound sfx_close_door_campus_1
    ...
    th "Но все равно, я это напишу. Я не могу больше терпеть!"
    dreamgirl "Ещё не сложившиеся в слова буквы рвались наружу, и не давали больше ни о чём другом думать."
    dreamgirl "Мику погрызла колпачок ручки, посмотрела в окно на лес, посмотрела на акварель над Лениной кроватью. И, с силой нажимая на стержень так, что едва не рвалась бумага, вывела заголовок на первой строке первой чистой страницы: «Костёр» — и, чуть ниже: «Действующие лица»."
    dreamgirl "Надо было поспешать — если Мику хотела поставить спектакль до того, как гости покинут лагерь, то надо было успеть написать текст до вечера."
    hide mi with moveoutright
    play sound sfx_dinner_jingle_normal
    dreamgirl "Так её и застала Лена, пришедшая положить книжку перед ужином: яростно строчащую в тетрадке, перечитывающую, вымарывающую не понравившиеся слова и предложения, или даже вырывающую страницы целиком, тихо ругающуюся или тихо хвалящую саму себя по поводу качества написанного."
    dreamgirl "Лена подняла несколько вырванных страниц, почитала."
    play sound sfx_close_door_1
    show un serious pioneer with dspr
...
label cracks_:
    ...
    dreamgirl "А Ульяна боялась. На грани паники. Нужно было вводить иглы в Семёна, а она боялась и каждый раз замирала, прежде чем коснуться иглой его кожи."
    dreamgirl "Но понимал это только Семён — просто чувствовал, как дрожит игла в момент касания."
    dreamgirl "Поэтому, когда все закончилось, а спина его украсилась двумя рядами проволочных шипов, Семён осторожно повернул голову, поймал взгляд Ульяны и сказал ей одними глазами: «Ты молодец, Рыжик»."
    dreamgirl "Виола осторожно накрыла Семёна простыней, перевернула песочные часы, и уселась, развернув стул спинкой к столу. Приглашающе кивнула Ульяне, садись-мол, хоть на вторую кушетку."
    ...
    dreamgirl "Мику умела работать очень быстро, поэтому, когда Лена вернулась, принеся ужин, основная часть текста была уже написана, раскрытая тетрадка лежала на кровати, а Мику сидела на крыльце, глядя куда-то в пространство."
    ...
    dreamgirl "Леночка занесла в домик судок с макаронами по-флотски и термос с чаем, коснулась рукой тетрадки, но, без разрешения автора, читать не решилась, а вместо этого вышла наружу и присела рядом с соседкой."
    stop ambience
    ...
    mi "Я сейчас."
    mi "Что-то вымотал меня этот четырехчасовой марафон."
    mi "Никогда раньше столько не писала."
    mi "А тут вдруг как накатило."
    mi "Я и остановиться не могла."
    mi "Пока всё не закончила."
    dreamgirl "Мику действительно вымоталась. Это было заметно даже по тому, что говорила она непривычно медленно и короткими фразами, как будто с трудом подбирая слова, как будто все слова были истрачены на написание текста и сейчас их запас ещё не успел восстановиться."
    dreamgirl "Девушки одновременно поднялись. Чуть замешкавшись в дверях, пропуская одна другую, зашли в домик."
    stop ambience
    ...
    dreamgirl "Мику, постепенно приходя в себя, занялась ужином, а Лена устроилась у себя на кровати со свеженаписанной пьесой."
    mi "Ну и как, Леночка? Я писала, писала… Все, что приходило в голову."
    show mi serious pioneer with dspr
    mi "Остановлюсь, перечитаю все, что написала, что-то поправлю и дальше пишу. Как так можно?"
    ...
    dreamgirl "Мику ждала Лениной оценки и отчаянно волновалась. Впервые она написала что-то серьёзнее школьного сочинения. Впервые она придумала что-то."
    dreamgirl "Система и создатели наградили её способностями к музыке, вокалу, танцам и все это воспринималось обитателями как должное и было для здешнего мира естественно."
    dreamgirl "А тут, впервые Мику сделала что-то такое, что не было ей подарено извне, что-то, что вышло изнутри её, ценой нервных клеток, ценой зверского голода, ценой головной боли и жуткой опустошённости. Что-то такое, что она довела до конца."
    dreamgirl "Впервые один из обитателей бесконечного лета придумал, создал, довёл до конца и представил на суд других что-то действительно новое, чего не было раньше."
    dreamgirl "И мир бесконечного лета ещё чуть-чуть изменился."
    un "Мику. Если хочешь, я могу помочь с запятыми. Скажи. Ты ведь собираешься показать это Семёну? Ты ведь о нем это написала?"
    show mi normal pioneer with dspr
    mi "Да, Леночка. Сегодня Семён приходил за гитарой, а мы с Алисой после поговорили о гостях."
    mi "Как они рассказали Алисе и нашей Ульяне сказку про пионеров, которые все время проживали одну и ту же смену по кругу, так что никто ничего не помнил, а один мальчик все вспомнил, но начал расти."
    mi "Алиса пересказала её мне, а ещё рассказала про то, какой сон Ульяне приснился, и как Алиса сама представила себе, что она стоит на берегу, а Семён уплывает на лодке. И вот я все это объединила. Просто так представила себе, что это все про нас и все это было на самом деле."
    show mi serious pioneer with dspr
    mi "Хочу ли я Семёну это показать? Нет, в таком виде не хочу."
    dreamgirl "Мику катастрофически не с кем было посоветоваться. Ей был симпатичен Семён, но она не решалась подходить к нему с такой просьбой. Оставалась Лена, для моральной поддержки."
    ...
    stop music fadeout 1
    dreamgirl "В библиотеке, кроме всего прочего, была пишущая машинка, к которой прилагалась Женя. Обе: заведующая библиотекой и руководитель музыкального кружка, — всегда несколько пугали друг-друга, но деваться им было некуда, тем более, что текст был хорош."
    stop ambience
    ...
    dreamgirl "Семён поймал удивлённый взгляд Ульяны."
    me "Черт! Наших, местных, тутошних, тамошних, здешних… Я запутался с этими двойниками, Уля. Конечно здешних."
    me "Так что давай. Начнём от площади?"
    dreamgirl "Оба прокручивали в головах разговор с Виолой и Толиком, который никому ничего толком не дал."
    stop ambience
    ...
    show d_to normal pioneer with move:
        xpos 0.1
    show cs normal glasses at left with move
    cs "Бери. Если успеешь до вашего ухода. Все равно в цифрах лучше тебя никто не разберётся. Есть ещё Шурик из вашего узла, но он, сами понимаете…"
    ...
    me "Понятно. Однажды я успел его поймать до того, как он, в очередной раз, стер сам себя и спросил только: «Почему?». А он ответил, что настоящий Александр давно умер, и не надо пытаться его вернуть, а надо дать шанс настоящему хозяину этого тела."
    ...
    scene ext_square_night with moveinright
    play ambience ambience_camp_center_night
    show d_sf normal hike at cleft
    show d_us normal dress at cright:
        ypos -0.05
    ...
    scene ext_house_of_dv_night with moveinright
    play ambience ambience_camp_center_night
    ...
    scene dct_ext_houses_night with moveinright
    play ambience ambience_camp_center_night
    show d_sf normal hike at cleft
    show d_us normal dress at cright:
        ypos -0.05
    ...
    hide us with moveoutright
    me "Ну все, показала ты мелкой дорогу. Теперь до конца смены девочка будет занята, а вожатая будет скучать."
    stop ambience
    
    scene ext_clubs_night with moveinright
    play ambience ambience_camp_center_night
    ...
    scene dct_ext_house_of_un_night with moveinleft
    play ambience ambience_camp_center_night
    show d_sf normal hike at cleft
    show d_us normal dress at cright:
        ypos -0.05
    ...
    me "Не удобно окажется, если она как раз сейчас к нам стучится."
    stop ambience

    scene ext_house_of_mt_night with moveinleft
    play ambience ambience_camp_center_night
    ...
    scene dct_ext_library_night_with_light with moveinright
    play ambience ambience_camp_center_night
    show d_sf normal hike at cleft
    show d_us normal dress at cright:
        ypos -0.05
    with moveinleft
    dreamgirl "Библиотека оказалась обитаема, в библиотеке горел свет и, сквозь приоткрытое окно, был отчётливо слышен стук пишущей машинки и спорящие о чем-то голоса."
    dreamgirl "Казалось, что спорят между собой скрипучая дверь и серебряный колокольчик."
    ...
    dreamgirl "На оконной занавеске мелькнула тень. Сначала в профиль, потом повернулась и стало видно причёску. Очень характерные хвостики."
    me "И Лена здесь. Ладно, спать пора, пусть делают что хотят. Все, что нам нужно знать, мы узнаем завтра."
    stop music fadeout 1
    stop ambience
...
label artists_:
    ...
    play ambience ambience_camp_center_day
    dreamgirl "Вторую ночь подряд Алисе плохо спалось. Правда, на этот раз причина была не в ней… Ульянка. Ульянка поднималась несколько раз, выходила куда-то и при этом невольно будила соседку."
    dreamgirl "Пришлось Алисе шикнуть на неё, чтобы Ульянка, проворчав что-то недовольно-жалостливое, наконец угомонилась."
    dreamgirl "А Алиска так и проворочалась до самого утра и в результате проспала линейку и едва-едва не проспала завтрак."
    play sound sfx_close_door_campus_1
    show dv normal pioneer with dspr
    ...
    hide dv with moveoutleft
    dreamgirl "Алиса начала проталкиваться к информационному стенду."
    
    scene dct_ext_bulletin_board with dissolve
    dreamgirl "Все приказы, распорядок дня, правила поведения, план лагеря, — всё оказалось скрыто под листами бумаги с каким-то, напечатанным на машинке текстом."
    ...
    dreamgirl "Зря Женя напечатала этот самый список действующих лиц в алфавитном порядке. Идиоткой Алиса точно не была, кто такая \"Анфиса\" поняла сразу, а про свою характеристику она прекрасно знала, и характеристика эта её раздражала."
    dreamgirl "Тот же Семён её однажды так и назвал. Тот цикл давно уже канул в Лету, а вот эти два слова засели в памяти у всех причастных."
    ...
    show dv normal pioneer with dspr
    dreamgirl "Алиса, уже успокоившись, хмыкнула и приступила к собственно тексту."
    stop music fadeout 2
    stop sound_loop
    stop ambience
    ...
    show promo_text u"На лесной поляне вокруг костра сидят пионеры и вожатая. Одно место в круге пустует.\nАнфиса задумчиво перебирает струны на гитаре…\n{b}Лариса.{/b} Оксана Сергеевна, мы кого-то ждём? Почему мы сели так, чтобы одно место у костра осталось свободным?.." as promo_text_2 with dspr:
        xpos 0.05 ypos 0.2
    dreamgirl "Кто-то подошёл и встал за левым плечом. Семён — тоже заинтересовался."
    ...
    with dspr
    dreamgirl "Алиса только молча кивнула в ответ."
    me "А очень даже здорово написано. Все-таки Мику — гениальнейшая девочка. Вот и есть альтернатива спортивному празднику, осталось только «Оксану Сергеевну» уговорить."
    dreamgirl "На последнем листе пьесы была приписка от руки: «{i}Желающие принять участие в постановке — записывайтесь в библиотеке. Сегодня после обеда первая репетиция, завтра вечером — премьера»{/i}."
    ...
    hide d_sf with moveoutright
    dreamgirl "Алиса скептически хмыкнула, проводив Семёна взглядом. Постояла ещё, дочитывая текст, и отправилась к себе."
    hide dv with moveoutleft
    show mi shy pioneer with moveinright
    dreamgirl "А «гениальнейшая девочка», прятавшаяся всё это время на Ульянкином месте — в ближайших кустах, осторожно, так, чтобы никто не видел, выбралась на дорожку и, глупо улыбаясь подслушанной похвале, помчалась в библиотеку."
    dreamgirl "Несмотря на бессонную ночь, спать ей не хотелось совершенно."
    hide mi with moveoutright
    stop ambience
    ...
    dreamgirl "Ольга подняла голову, отвлёкшись от чтения, и искоса глянула на Семёна. Впервые за всю беседу."
    ...
    dreamgirl "Так получилось, что у стенда, кроме работников столовой, не побывало только четверо: Виола с Анатолием и обе Ульяны."
    dreamgirl "Виола и Анатолий засели в медпункте, пытаясь понять, что же им нужно делать; Ульяна-большая, выгнав Семёна, чтобы не мешался, валялась в спорткомплексе на стопке матов, обложившись тетрадями, в попытке разобраться в логике бабы Глаши; а Ульяна-маленькая, набив карманы конфетами, опять умчалась в старый лагерь."
    ...
    show mz angry glasses pioneer with move:
        xpos 0.35
    mz "Да что это такое? Чуть страницу псу под хвост не отправила! Счастье твое, что это исправить можно! Семён! Или говори — зачем припёрся, или сразу уходи! А то сейчас выгоню!"
    ...
    dreamgirl "Женя уже успокоилась и не рычала, а тихо и неожиданно уютно поскрипывала."
    ...
    show mi happy pioneer with dspr
    mi "…"
    dreamgirl "Правда, дальнейшие действия Семёна девочек несколько озадачили. Он вручную пронумеровал все страницы, что было понятно, а на последней странице, уже после текста, написал: «Узел №15», — и ещё несколько цифр, которые очень походили на дату, если бы не год — две тысячи восьмой."
    ...
    dreamgirl "Семён встал, покрутил головой, углядел в одном из шкафов несколько пустых канцелярских скоросшивателей, спросил у Жени и, получив в ответ взмах рукой: «Можно-можно, только проваливай», — взял один, вложил в него текст, и направился к выходу."
    hide d_sf with dspr
    $ renpy.pause (1)
    show d_sf normal pioneer at right with dspr
    ...
    hide d_sf with dspr
    show mi normal pioneer with dspr
    dreamgirl "Будущие звезды больших и малых академических театров несколько секунд молчали, глядя на администрацию театра, а потом Катя, пересилив накатившее волнение, спросила."
    ...
    dreamgirl "На столе лежали логарифмическая линейка и две раскрытые тетради бабы Глаши. Рабочая тетрадь закрылась, когда Ульяна отвлеклась на приход Семёна, и только карандаш не давал тетради закрыться окончательно."
    dreamgirl "Семён ещё полюбовался выражением Ульяниного лица: внешне серьёзно-упрямым и в то же время с то и дело проскакивающими хитровато-озорными проблесками в глазах."
    dreamgirl "Как будто Ульяна только что придумала очередную свою шкоду и сейчас работает над её воплощением в жизнь."
    stop music fadeout 1
    stop ambience
...
label unclaimed_revelation:
    ...
    us_old "У бабы Глаши, Сём, был Мозг, вот она все, что мне нужно, и прописала только в самом общем виде и успокоилась."
    ...
    th "Все-таки дистанция между нами есть дистанция."
    ...
    hide sl with moveoutright
    dreamgirl "Вот у октябрят, у тех никаких комплексов не наблюдалось. Половина с визгом скатывалась по горке в воду, а несколько человек подошли к Семёну, присели рядом с ним на корточки и о чём-то с ним беседовали."
    dreamgirl "Славя даже заревновала чуть-чуть."
    show sl normal swim with dspr
    th "Я умею с малышней обходиться и малыши меня чужой не считают, но чтобы самим вот так посвящать в свои дела…"
    ...
    th "А мне обидно."
    hide sl with dspr
    dreamgirl "Вдруг Вася — самый тихий, что-то сказал такое, что Семён аж замер на полуслове и вдруг разулыбался — рот до ушей, хлопнул ладонью по песку, ответил Васе так, что вся компания тоже заулыбалась, и пожал каждому руку."
    ...
    dreamgirl "Но, как бы то ни было, а режим есть режим и чаще добрым словом, а пару раз и мягким понуканием, но октябрята были выгнаны из воды, вытерты, переодеты, одеты и отправлены по домикам."
    dreamgirl "Пока Славя возилась с малышами, о Семёне и не вспоминала."
    show sl scared swim with dspr
    dreamgirl "Но, как только последний малыш был одет и пришло время одеваться самой, голова сама повернулась к месту, где загорал гость лагеря."
    show sl shy swim with dspr
    th "Ушёл? И… хорошо."
    stop music fadeout 1
    stop ambience
    
    scene ext_square_day with moveinright
    play ambience ambience_camp_center_day
    dreamgirl "До площади всем — и малышам и Славе было по пути, поэтому шли по главной аллее, мимо склада и столовой из которой уже вкусно пахло, не разбредаясь."
    ...
    dreamgirl "Славя любила детей и любила общаться с детьми. Слушать их истории, а эта история была интересная."
    ...
    d_sz "Вы, старшие, иногда перестаёте забывать и много смен все помните. А потом опять забываете."
    ...
    dreamgirl "Ну да, в таком возрасте охотно веришь в собственные фантазии. Славя не выдержала прилива нежности и запустила ладони в волосы близнецов, прихватила пряди и чуть подёргала, не больно и не обидно, а именно так, чтобы близнецы почувствовали ласку."
    d_oz "Артём говорит, что Семён очень хороший. Но ты, Славя, тоже хорошая."
    dreamgirl "А Серёжа, тот смутился и отдёрнул голову."
    ...
    play sound sfx_dinner_jingle_normal
    dreamgirl "Жалко было отпускать ребят, но режим важен для малышей."
    show sl normal pioneer with dspr
    ...
    scene ext_path2_day with squares
    play ambience ambience_forest_day
    dreamgirl "Если бы Славя видела сквозь деревья, то сейчас бы она смогла увидеть, как на Ульянкиной тропе столкнулись Семён, идущий из библиотеки к спортзалу, и Артём, бегущий с футбольного поля к себе в домик."
    dreamgirl "Как они стояли друг напротив друга, как потом одинаковыми движениями полезли себе за воротники, и как достали оттуда висевшие у каждого на шее: Артём свисток на зелёной тесьме, а Семён двадцатикопеечную монету на витом чёрном капроновом шнурке."
    dreamgirl "Как оба расплылись в улыбках, как подошли друг к другу и пожали руки."
    show d_sf smile pioneer at left with moveinleft
...
label shear_deformations:
    ...
    $ persistent.sprite_time = "day"
    play ambience ambience_camp_center_day
    dreamgirl "Славя повесила сушиться купальник и пляжное полотенце."
    dreamgirl "Кто-то и когда-то натянул за домиком верёвку. Явно именно для этого."
    dreamgirl "Обошла домик, кивнула проходящему мимо Артёму."
    play music music_list["timid_girl"]
    show sl normal pioneer with moveinleft
    ...
    dreamgirl "Когда Семён вернулся перед ужином в тренерскую, там ничего не изменилось. Его Ульяна все так же сидела за столом, поджав под себя одну ногу, все так же грызла колпачок ручки, все так же периодически запускала пятерню в свои волосы."
    dreamgirl "Только количество исписанных листов в тетради выросло, а одну тетрадь бабы Глаши сменила другая. И ещё одна деталь изменилась — во взгляде Ульяны пропали озорные искорки. Теперь за столом сидела девушка чем-то потрясённая. Например, свалившимся на неё известием."
    show d_sf normal pioneer at left with moveinleft
    play ambience ambience_int_cabin_day
    play sound sfx_close_door_1
    ...
    me "Что?"
    show d_us normal sport with dspr
    us_old "Все хочу тебя спросить. А дальше что было?"
    show d_sf laugh pioneer with dspr
    ...
    dreamgirl "У обоих были свои мысли. И про систему, и про Виолу с Анатолием, и оба боялись не то что вывалить их на друг на друга, но даже полностью проговорить их самим себе, оставляя пока на уровне ощущений и образов."
    stop music fadeout 1
    stop ambience
    ...
    play ambience ambience_int_cabin_day
    play music higekitekina
    dreamgirl "Алису сигнал к ужину застал дома. Она мучила гитару, устроившись на кровати, и опять проживала в своём воображении тот давний момент бегства Семёна на украденной лодке."
    play sound sfx_dinner_jingle_normal
    ...
    dreamgirl "Репетиции внезапно возникшего театрального кружка шли в кружке у Мику и Алисе было интересно. Всем было интересно, но посторонних не пускали."
    ...
    scene int_musclub_day with squares
    play ambience ambience_music_club_day
    dreamgirl "В музыкальном кружке по случаю прозвучавшего сигнала на ужин оставалась одна Мику. Редкий для Мику момент — она была сердитая и расстроенная."
    ...
    dreamgirl "Мику даже вспыхнула от удовольствия, мгновенно меняя настроение от текущей подавленности на свой повседневный сверхпозитивный оптимизм."
    show dv guilty pioneer2 with dspr
    dreamgirl "А Алисе опять вспомнился последний кадр из собственной фантазии, с лодкой, чуть накренившейся, с набравшим ветер небесно-голубым самодельным парусом."
    dv "Скажи, Мику. А ты не знаешь, где пятая портьера?"
    show mi shy pioneer with dspr
    mi "Пятая? Не знаю, Алисочка. Их так и было четыре, когда мы приехали. Вчера, когда Семён за гитарой приходил, он тоже все смотрел на эти портьеры. Мне так неудобно было, будто это я сама пятую портьеру потеряла."
    dv "А ты не теряла?"
    ...
    mi "Алиса! С тобой все хорошо?!"
    show dv normal pioneer2 with dspr
    dv "Нет-нет. Все хорошо, Мику. Если тебе нужна помощь, я помогу."
    show mi happy pioneer with dspr
    ...
    dreamgirl "Алиса отпустила Мику вперёд, а сама, дойдя до главной аллеи, свернула к пристани. Ей нужно было попасть на остров для последней проверки. Для этого у Алисы было ещё полтора часа времени."
    stop ambience
    ...
    dreamgirl "Ульяна и Семён посмотрели друг на друга и девушка показала взглядом: «Говори ты»."
    show d_us normal dress with move:
        xpos 0.95 ypos -0.05
    show d_sf normal hike at right with moveinright
    ...
    dreamgirl "Искать ничего не пришлось. Все это барахло лежало именно там, под тем кустом, куда его сунула в своих, как она считала, фантазиях Алиса."
    stop ambience
    ...
    $ persistent.sprite_time = "sunset"
    show dv guilty pioneer2 with dspr
    dreamgirl "Алиса чуть дрожащими руками спрятала находку назад под куст, потом подумала, вытащила верёвку и так с бухтой верёвки в руках пошла на противоположную сторону острова — обратно к лодке."
    stop ambience
    
    scene dct_ext_island_sunset with moveinleft
    play ambience ambience_lake_shore_evening
    ...
    dreamgirl "И верёвка полетела подальше в воду."
    ...
    play ambience ambience_int_cabin_evening
    dreamgirl "Славя вернулась с ужина в домик и опять встала перед зеркалом."
    ...
    dreamgirl "И неизвестно почему, ведь не хотела же. До ужина ещё не хотела, и сама посмеялась этой бредовой идее, но Славя попросила."
...
label splinters_:
    ...
    play ambience ambience_int_cabin_night
    play music music_list["door_to_nightmare"]
    dreamgirl "Семён проснулся как от толчка." with hpunch
    dreamgirl "Было самое начало третьего часа ночи, и всякая послеотбойная жизнь в лагере уже давно затихла: уже погас свет в медпункте, уже закончилась репетиция в театральном кружке, уже обошла территорию вожатая, уже Рыжие совершили ночной набег на столовую и успели уничтожить улики."
    dreamgirl "Давно уснули самые отъявленные полуночники и страдающие бессонницей. Кузнечики замолкли, а утренние птицы ещё не начинали проверять голос. Семён лежал и пытался понять одно: что же его разбудило."
    dreamgirl "В тренерской было темно, и только под дверью угадывалась сероватая полоска; стояла абсолютная тишина, а на плече уютно сопела Ульяна, что за нарушение тишины не считалось; ни спина, ни зубы не болели. Казалось бы — закрывай глаза и досыпай."
    dreamgirl "А Семён лежал с открытыми глазами и героически пытался ни о чём не думать. Не получалось."
    dreamgirl "Вспоминался прошедший вечер: беседа с Виолой и Анатолием, особенно фраза, брошенная Виолой на прощание: «Думаешь, ты один до этого додумался?»; репетиция, на которую их деликатно, насколько это возможно со стороны Алисы, но решительно не пустили; вопросительный, нет не вопросительный, а о чем-то молящий взгляд той же Алисы."
    dreamgirl "Вспоминалась высунувшаяся было из домика, и тут же спрятавшаяся назад Славя, что-то было в ней не так, но она так быстро мелькнула, что Семён не понял, что именно."
    dreamgirl "Отдельно вспомнилась беседа с Артёмом за ужином. Они втроём специально сели за один стол и никто, кроме мелких, не понял, почему и зачем."
    show blink
    ...
    show d_ar normal pioneer at right:
        ...
        #ypos 0.05
    with dspr
    me "Я все гадал, куда ты подевался. А ты здесь."
    d_ar "А я здесь."
    me "А почему сразу не подошёл?"
    show d_ar dontlike pioneer with dspr
    d_ar "Я думал ты все забыл и не узнаешь меня, как…"
    show d_us sad sport with dspr
    ...
    d_ar "Мы в самый первый день, как приехали считаемся. Как-будто домики делим. А те, кто не спит, те понимают о чем речь и называются."
    ...
    play sound dct_sfx_wood_floor_squeak
    dreamgirl "Открыл дверь и в лунном свете, заливавшем спортзал, нашёл свои кеды, обулся и вышел. Подумал об Ульяниных страхах, и, прикрыв дверь, включил в спортзале свет. Если проснётся, то света, пробивающегося под дверь, ей будет достаточно."
    th "Взрослая ведь уже, а так и боится оставаться ночью одна, в темной комнате. Что там было в её биографии? Мнимой или реальной. Её самой или её оригинала."
    dreamgirl "Подумал ещё написать записку, чтоб не волновалась, если проснётся одна, но не стал. Это надо было возвращаться в комнату, шариться в темноте по столу и в столе, в поисках бумаги и ручки, включать свет. А значит — гарантированно разбудить Ульяну."
    th "Далеко не пойду. Так, постою на крыльце."
    stop ambience
    
    scene ext_beach_night with dissolve
    #play ambience ambience_camp_center_night
    dreamgirl "На улице было прохладно и светло от полной Луны."
    ...
    th "Все-таки это — мой мир. Не тот, с той стороны теплообменника, или откуда там приходил Пионер, а именно этот. Надо его сохранить, и как мне ни жаль, но придётся Виолу и Толяныча огорчать и ставить перед выбором. Интересно, что там Рыжик насчитала?"
    th "Пойти пройтись ещё? Я недалеко, только спортплощадку обойду по кругу и назад."
    #stop ambience

    scene ext_playground_night with dissolve
    #play ambience ambience_camp_center_day
    dreamgirl "Семён прошёл вдоль спортзала и по тропинке между туалетом и спортзалом вышел на футбольное поле."
    stop music fadeout 1
    ...
    dreamgirl "И тут же, словно от удара по мячу, включились остальные, дополнительно к зрению, органы чувств. Стало слышно, как ёжик фыркает и топает где-то под скамьями; лёгкий ветерок приласкал правую щеку; запахло близким лесом."
    ...
    stop sound_loop
    dreamgirl "Удары по мячу стихли и стали слышны девичьи голоса. Знакомые и незнакомые одновременно."
    ...
    dreamgirl "И заблокированный цикл с отчётливым таким щелчком занял в памяти Семёна своё место."
    me "Это… болезненно." with flash
    dreamgirl "Да что там, больно это было."
    me "Ох." with flash_red
    dreamgirl "К счастью удалось устоять на ногах."
    play music a_v_to_the_crows fadein 2
    me "Вы — не они!"
    dreamgirl "В затылке Семёна что-то пульсировало, и мир плыл перед глазами. Очень хотелось сесть, хоть прямо на землю."
    ...
    show d_mi cry_smile casual with dspr:
        xpos 0.05
    mi "Сенечка!"
    mi "Вот так, Славечка. Говорила ты, говорила, и все зря. Сенечке же очень плохо и ему не до нас. Сенечка, мы действительно не они. Мы то, что осталось от них в памяти системы."
    ...
    d_sl "Тридцать циклов я держалась, мне было все хуже и хуже, а меня все перекидывало из лагеря в лагерь, это Система искала мне место, но не нашла."
...
label repetition_:
    ...
    $ persistent.sprite_time = "day"
    play ambience ambience_int_cabin_day
    dreamgirl "Ольга Дмитриевна проснулась с чувством лёгкого беспокойства."
    ...
    th "Кстати, не забыть выяснить, куда пропадает Ульяна-маленькая, и не забыть предложить гостям уехать на автобусе — все-таки неплохие люди."
    stop ambience
    
    scene d2_mt_undressed with dissolve
    play ambience ambience_int_cabin_day
    mt "Вот жили мы тут, жили, никого не трогали. И вот на тебе, получи Оленька, соседа в домик. Пубертатного возраста."
    mt "Вещи... Можно все развесить и завтра, но… Нет. Мало ли что может случиться до завтра."
    play sound dct_sfx_wood_floor_squeak
    dreamgirl "Вожатая одевалась, одновременно прятала разбросанную по домику одежду в шкаф и ворчала себе под нос."
    stop ambience
    ...
    th "Наказывать не за что. Прическа осталась в допустимых рамках, подумаешь — косы обрезала. Но мне ещё с её родителями разговаривать."
    ...
    me "А ещё, она единственная из не готовых проснуться девочек поверила мне, и понимала, что исчезнет. И вела себя так, что я и сейчас завидую её мужеству, и тогда завидовал."
    ...
    stop music fadeout 1
    show d_us smile sport with dspr
    us_old "Пошли завтракать, Сёмк. Может, там ещё не все съели."
    stop ambience
    ...
    show dv normal pioneer2 with dspr
    dv "Знаешь, Мику. Кажется я поняла в чем дело. Давай мы сами сейчас прочитаем отрывок и посмотрим, что у нас получится."
    stop sound_loop
    stop ambience
    ...
    dv "Вот, можете же!"
    dreamgirl "Да, так дело пошло. Пионеры к середине репетиции наконец поняли, что от них хотят, и финальная сцена прошла уже почти без сбоев."
    play sound_loop ambience_medium_crowd_indoors_1
    voice "Музыки в конце не хватает."
    #Двойник той Кати, что бегала с Сашкой по утрам в лагере бабы Глаши, кокетливая блондинка в жизни, она играла Анфису. Причём очень хорошо играла. Алиса, наблюдая за ней, несколько раз вздрагивала: «Неужели это я? Я, я же не такая!» — но понимала, что да — именно такая. «Да и черт с ним. Я такая, какая есть!»
...
label anticipation_:
    ...
    th "Лагерь, он, конечно, маленький, но пока все обойдёшь. А Семёна надо до обеда найти, чтобы он хоть на одну репетицию да попал."
    ...
    sl "А они там так кричат, а окно открыто. Только непонятно ничего. Я и ушла сразу, чтобы не подумали, что я подслушиваю."
    show un serious pioneer with dspr
    ...
    th "А вот как Женя лязгнула ножницами и две косы упали на пол — так сразу стало понятно, что все будет… нормально. Правильно все будет."
    ...
    us_old "Виола, а расскажи о нем."
    cs "О ком? О дубликате или об оригинале?"
    us_old "О моём Сёмке. Я же не знаю о нем почти ничего. И он не помнит."
    cs "А никто почти ничего не знает о твоём Сёмке. Он особо не мелькал, ну и для нас в посёлке был одним из многих."
    cs "А потом, когда все случилось, оказалось, что он единственный из вас в активной фазе, каким-то образом его оригинал сумел это устроить и спас его от Выключателя."
    ...
    us_old "Потому и противоречие, потому всё и разваливается, что те, кто уже проснулся тянут в одну сторону, вы привязаны к тому миру, что снаружи. А те, кто спят — в третью. Вот и разваливается все. Потому Сёмка и предложил вам уйти через теплообменник."
    show cs shy with dspr
    cs "Есть ведь ещё и Выключатель. Чтобы привести всё к одному вектору."
    us_old "Виола, ты о чем? Я не согласна, имей в виду. А Выключатель и у Сёмки есть."
    show cs normal with dspr
    ...
    mi "Все замечательно, Ольга Дмитриевна. Ещё и Семён согласился нам помочь!"
    ...
    $ renpy.pause (1)
    $ set_mode_nvl ()
    dreamgirl "Что-то ещё беспокоило Ольгу Дмитриевну. То же самое неясное предчувствие непонятных перемен, что и утром."
    dreamgirl "И поэтому известие о том, что Толика нужно везти в город, вожатая восприняла даже с облегчением: кажется, ничего страшного."
    dreamgirl "Ольга Дмитриевна не могла видеть, что лагерь сейчас напоминает бак с перегретой водой, в который попало несколько пылинок, вокруг этих пылинок уже начали образовываться первые пузырьки пара, и вода в котле вот-вот вскипит, сразу и во всем объёме."
    dreamgirl "Следующий цикл обещал быть очень интересным. Система это фиксировала и Ольга, как человек связанный с Системой, эту фиксацию подсознательно воспринимала, а уже сознание Ольги трактовало полученную информацию, как ожидание перемен."
    dreamgirl "Нервное, но не тоскливо-безнадёжное, кстати, ожидание."
    $ set_mode_adv ()
    stop ambience
...
label strange_memory:
    ...
    show d_us smile sport with dspr
    us_old "Только ты, главное, смотри там, на Мику не заглядывайся. Мне-то сколопендру поймать не долго."
    ...
    play ambience ambience_forest_day
    $ set_mode_nvl ()
    dreamgirl "Не пошли они ни к какой сцене. Где-то было слышно, как пионеры играют в футбол, где-то вожатая искала свою помощницу, где-то Виола сформулировала мысль и искала Ульяну, чтобы поделиться с той, до своего ухода."
    dreamgirl "А девушки просто неторопливо гуляли по лагерному лесу, переходя с тропинки на тропинку."
    $ set_mode_adv ()
    play sound_loop dct_sfx_steps2
    show d_us normal sport at right:
        ypos -0.05
    ...
    play ambience ambience_camp_center_day
    dreamgirl "Земляника была мелкая, было её немного, но задержаться около неё стоило."
    show d_us normal sport at right:
        ypos -0.05
    show d_sl normal pioneer at left:
        ypos -0.1
    ...
    sl "Пойдем. Ни разу еще не бывала за забором, всё некогда. Только на остановке."
    play sound_loop dct_sfx_steps2
    show d_sl shy pioneer with dspr
    ...
    play ambience ambience_forest_day
    dreamgirl "В лесу без ветра было по особенному душно — обычный жаркий день бесконечного лета."
    show d_us normal sport at right:
        ypos -0.05
    show d_sl normal pioneer at left:
        ypos -0.1
    ...
    play ambience ambience_forest_day
    dreamgirl "Разговор незаметно отклонился от главной темы."
    show d_us smile sport at right:
        ypos -0.05
    ...
    show d_sl smile2 pioneer with dspr
    sl "А зачем? Здесь все равно никто не ходит."
    show d_sl normal pioneer with dspr
    ...
    scene ext_path_day with slideright
    play ambience ambience_forest_day
    dreamgirl "К счастью, мгновенного ответа не требовалось."
    dreamgirl "Девушки успели искупаться и уже возвращались в лагерь, когда Ульяна наконец нашла нужные слова."
    dreamgirl "Семён когда-то делился с ней своим опытом общения с ещё не проснувшимися пионерами, которые вот-вот проснутся. Но все вылетело из головы."
    dreamgirl "Осталась только фраза: «Я, тогда подумал, что вот я тебе вечером совру, а твой разум возьмёт и проснётся утром. И что мне? На сто восемьдесят градусов разворачиваться? Так я слишком ленивый для этого. Лучше было правду сказать и наплевать, на то, что ты в неё не поверишь»."
    show d_us normal sport at right:
        ypos -0.05
    show d_sl normal pioneer at left:
        ypos -0.1
    ...
    show d_sl serious pioneer with dspr
    sl "Повезло? Как?"
    us_old "…мне сейчас все равно, поверишь ты или нет, я, действительно, уйду завтра. Но ты не похожа на нормальную, ты и есть нормальная!"
    ...
    us_old "В моем лагере нет твоего двойника, там живёт другая девочка. Похожая на тебя, но другая. Так что ты единственная Славя, которую я знаю."
    ...
    play ambience ambience_camp_entrance_day
    dreamgirl "Обратно шли молча, свернув на знакомую Славе тропинку, выводящую к остановке. Ульяна, чем-то расстроенная, молчала. Славя же не знала, как отнестись к словам гостьи. С одной стороны, Ульяне не было нужды её обманывать, а с другой — все это звучало, как продолжение вчерашних фантазий ребятишек из младшего отряда."
    show d_us normal sport at right:
        ypos -0.05
    show d_sl normal pioneer at left:
        ypos -0.1
    ...
    show d_us normal sport at center with moveinright:
        ypos -0.05
    us_old "Это не ты, Славя, тайны коснулась. Это мы тебя в неё нечаянно макнули. Скоро все сама поймёшь. Дней через восемь-девять точно."
    show d_us smile sport with dspr
...
label dots_over_yo:
    ...
    show d_us normal sport at cright:
        ypos -0.05
    with dspr
    us_old "Знаешь, Сём. Славя что-то начинает понимать. О чём-то догадываться. У неё…{w=1}появились вопросы. А я ей сказала, что она скоро все сама поймёт. И, Сём. Придётся на следующий цикл сюда прийти. Я Славе пообещала, что одну её не оставим."
    ...
    play ambience ambience_camp_center_day
    th "Все возвращается… Последние люди возвращаются домой. Семён вернулся туда, откуда начинал. В кои-то веки активация и побег пошли кому-то на пользу."
    ...
    th "Как это все-таки плохо: все знать, все помнить, все понимать, а общаться только раз в две недели с себе подобными."
    ...
    th "Может, все-таки бросить это дело, пустить узел на самотёк? Но Монитора и Матрицу жалко. Тоже личности своего рода. И одиночество. Так хоть с сестрёнками могу общаться, а иначе — только со случайно проснувшимися пионерами."
    th "А ещё — страшно."
    show d_sf normal pioneer at center with dspr
    ...
    dreamgirl "До ужина оставалось ещё целых три часа и в бедном на события «Совёнке» все замерло."
    dreamgirl "Мелкие сосредоточились на футбольном поле. Все, кроме Артёма."
    stop ambience
    
    scene dct_ext_house_of_kids_day with squares
    play ambience ambience_camp_center_day
    dreamgirl "Артём остался у себя в домике и что-то писал на вырванном из тетрадки двойном листе."
    stop ambience
    
    scene ext_beach_day with squares
    play ambience dct_ambience_beach
    dreamgirl "Средний отряд, включая артистов, оккупировал пляж."
    stop ambience
    
    scene ext_house_of_dv_day with squares
    play ambience ambience_camp_center_day
    dreamgirl "Алиса учила роль. Ей все-таки навязали роль Оксаны Сергеевны, и сейчас, когда Ульянки не было, она ходила по домику и повторяла реплики."
    dreamgirl "Она бурчала про себя, что её заставили, но, в глубине души, была рада. Участие в спектакле, как ни странно, приводило в порядок её мысли и успокаивало."
    stop ambience

    scene dct_ext_cliff_day with squares
    play ambience ambience_lake_shore_day
    dreamgirl "Ульяна-маленькая осваивала территорию Старого лагеря, и в данный момент сидела над берегом, свесив ноги с обрыва и разглядывая речной простор во «временно позаимствованный» в клубах бинокль (кибернетики запирали двери, но всегда забывали про форточки)."
    stop ambience
    
    scene ext_square_day with squares
    play ambience ambience_camp_center_day
    dreamgirl "Славе нужно было обдумать разговор с Ульяной-большой, поэтому она опять занялась цветами на площади."
    stop ambience
    
    scene dct_ext_stage_big_day with squares
    play ambience ambience_camp_center_day
    play sound_loop dct_sfx_hammering
    dreamgirl "Кибернетики решили, что лучше уступить Мику, чем отбиваться, и обустраивали сцену, старательно заглушая стуком молотков бесконечный монолог руководителя музыкального кружка."
    stop sound_loop
    stop music fadeout 1
    stop ambience
    ...
    $ set_mode_nvl ()
    cs "И кто-то из них обязательно спотыкается и его приводят к тебе, с разбитым носом, шатающимся зубом, и очень живописным животом в вертикальную красную полоску. Но главное, с торчащим из этого живописного живота куском арматуры. Или острым сучком. Или еще чем-то подобным. \nСлавя бегает, Ольга бегает, обе плачут. А ты знаешь, что независимо от твоих трудов, пионер завтра будет как огурчик, но все равно делаешь все как надо.\nОбрабатываешь его по полной программе, потому что давала клятву лечить людей. Да и просто его жалко. Пионер-то не знает, что он завтра будет как огурчик и страдает по настоящему. И все вокруг страдают."
    nvl clear
    cs "А через две недели ты, кажется, принимаешь все меры, но калечится уже другой пионер: или током бьет кого любознательного, или кто с качелей летит. И всё повторяется снова.\nИ ты принимаешь и принимаешь меры, и понимаешь, что бороться с этим — это как головы у змея рубить. Что все это зашито в программу, которую сама для себя составила Система.\nИ если ты, Ульяна, говоришь, что Система — это мы сами, то непонятно, для чего это Системе нужно. И тебе пионеров жалко, в том числе и поэтому, и еще за этот замкнутый цикл жалко, в который их сама же запихнула, а теперь не знаешь, как оттуда выдернуть.\nИ ты изображаешь из себя чудовище, чтобы не подпускать пионеров к себе, чтобы не пускать их себе в душу, а потом эта маска так прирастает, что уже не можешь остановиться. Но ты всё равно помнишь их всех по именам, и все их болячки по циклам."
    nvl clear
    cs "А пионер, который опаздывает на неделю, и все что мы смогли сделать для которого, это поселить в этом лагере — у себя на глазах, тычется, как слепой котенок и, кажется, не собирается просыпаться.\nА потом он внезапно сбегает, сначала подняв на уши, а потом вогнав в столбняк весь лагерь. И жизнь в лагере буквально останавливается. Все ходят как в воду опущенные и столовая не работает, и даже на приезд автобуса обитатели не реагируют.\nИ ты уже подумываешь, не применить ли прибор и не сбросить ли текущий цикл у пионеров, но рука не подымается.\nА сбежавший пионер не появляется на следующую смену. Вместо него, через несколько циклов, приезжает копия, с нулевой памятью, и еще является проекция того… пионера-искусителя."
    nvl clear
    cs "А сбежавший пионер пропал, о нем никаких известий и ты волнуешься, не встретился ли он с этим же самым пионером. Приборы не показывают изменения состояния Сети, но что приборы…\nА потом тревога — сброс ста восьми килограмм массы через теплообменник, и тебе опять ничего не понятно. Пока однажды не умудряется дозвониться Денисовна…"
    $ set_mode_adv ()
    show cs normal with move:
        xpos 0.75
    show d_to normal pioneer at left with moveinleft
    ...
    scene ext_boathouse_day with pushleft
    play ambience ambience_boat_station_day
    pause
    stop ambience
    ...
    us_old "Это за три-четыре цикла произойдёт. Но небольшая вероятность попадания сюда или ухода отсюда сохранится. Не смейся, но при помощи магических действий. Не важно, каких, главное — верить, что магия поможет."
    ...
    us_old "И все это случится за те же несколько сот циклов. Он ведь построен в таком пузыре. Как это будет выглядеть снаружи — я не знаю. Мне это сейчас неинтересно, а я и так безвылазно два дня просидела над бумагами…"
    stop ambience
    ...
    cs "Я знаю, все-таки не зря здесь торчала."
    show d_us normal sport with move:
        xpos 0.85 ypos -0.05
    show cs normal at center with move
    cs "Только я коротко. Все будет почти так, как сейчас."
    ...
    cs "Если, осознав себя, хоть что-то изменил в себе самом, то выпадаешь из этой сансары. Ну, а закончится все… так, как и должно в таком случае закончиться."
...
label the_day_after_tomorrow_bomb:
    ...
    play sound_loop ambience_medium_crowd_outdoors
    play music music_list["i_want_to_play"]
    dreamgirl "И вот настали долгожданные \"Двадцать ноль-ноль\", из-за которых пионеры потянулись на концертную площадку сразу же после ужина."
    dreamgirl "Все ждали начала спектакля, все уже сидели на скамейках и ждали — когда, наконец, откроется занавес."
    dreamgirl "«Совёнок» действительно был беден на развлечения, и любые внеплановые мероприятия здесь проходили на ура."
    dreamgirl "Ульяна-большая сидела в первом ряду, между Виолой и Ольгой Дмитриевной и, пока не начался спектакль, оглянувшись, рассматривала публику."
    ...
    $ set_mode_nvl ()
    play music badstory
    dreamgirl "Зашелестели раздвигаемые половинки занавеса, и публика увидела пионеров, сидящих подковой вокруг костра на лесной поляне."
    nvl clear
    ...
    dreamgirl "Закончилась песня. Погасло освещение на сцене, медленно погас костёр. Зажглись фонари на зрительской площадке. Занавес. Аплодисменты."
    ...
    play ambience ambience_camp_center_night
    play music music_list["mystery_girl_v2"]
    dreamgirl "Закончилось «сегодня» и наступило «завтра». Лагерь угомонился после запоздалого отбоя. Какое-то время на поляне за домиком Рыжих ещё можно было разглядеть две неясных фигуры. Но потом исчезли и они."
    stop music fadeout 1
...
label return_bus:
    ...
    cs "Ты обещал проследить, но мне все равно страшно. И начинай с меня. А то я боюсь, что брошусь на тебя, когда ты прицелишься в Толю."
    hide d_sf with moveoutleft
    ...
    me "Вот и все, Рыжик. Вот и закончилась эпоха. Хотя… нет, ещё не все. Где же он у меня?.."
    stop ambience
    ...
    voice "Нет. Когда я жила одна, мне было все равно, когда мне оставляла еду та женщина, которая сейчас уехала, нам тоже было все равно."
    us "Так не годится. У всех людей должны быть имена!"
    us "Скажи."
    us "Ты не против?"
    us "Если тебя."
    us "Будут звать."
    #dreamgirl "Ульянка повернулась, и, глядя тайне прямо в глаза, спросила."
    ...
    th "Рассеяные оба. Что один, что другой."
