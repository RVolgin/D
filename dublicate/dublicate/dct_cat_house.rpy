...
label dct_the_first_life:
    ...
    "Тем более, что и хозява её беспокойства не проявляли, а кошечка считала себя во всём подобной своим хозяевам."
    ...
    show cat_uv itchy small:
        pos (0.6, 0.8)
    with dspr
    mic "{i}Ох, Светка. Завела себе заменителя ребенка, а сама ему даже имя дать не удосужилась: доча, девочка, иногда — кошечка, а чаще всего — кошкодевочка.{/i}"
    ...
    mic "Кошкодевочка, может, ты на песок перейдешь?"
    play sound dct_sfx_meow4
    $ renpy.pause (1)
    mic "Ну, как скажешь."
    hide cat_uv with dspr
    ...
    show cat_uv waiting small with dspr:
        pos (0.6, 0.75)
    mic "Ну что, зверь. Проживешь без меня полдня?"
    ...
    show cat_uv itchy medium with dissolve:
        pos (0.25, 0.73)
    mic "Не доверяю я тебе. Боюсь — приду домой сегодня, а тут всё разгромлено одной ма-а-а-аленькой кошечкой. Выгнать её из дому тогда придется."
    mic "А ты только и рада будешь, если выгоню. Эта каморка даже для кощки тесная. Но потерпи, командировка закончится, мы на материк вернемся, в нормальную квартиру."
    ...
    $ persistent.sprite_time = "day"
    play ambience ambience_int_cabin_day
    "А кошечка ещё поиграла, пытаясь поймать собственную тень, подремала на хозяйской кровати, посидела на подоконнике. А потом, когда порыв ветра распахнул не закрытую на завертку форточку, перебралась туда."
    "Были бы дома хозяева, они бы не допустили такого. Домашних животных запрещалось держать в поселке, и котенка протащили нелегально, но хозяйка укатила на материк, хозяин ушел на работу, и снять безымянную кошку с окна оказалось некому."
    stop ambience
    ...
    show cat_uv walking small with dspr:
        pos (0, 0.85)
    "И пошла изучать территорию, попутно пытаясь охотиться на воробьев."
    ...
    show cat_uv waiting medium with dspr:
        pos (0.1, 0.6)
    voice "Ульяна! Ну где вы опять застряли? Тепловоз вас ждать не будет, давайте быстрее! Бумаги заберете и с дневным поездом сразу назад. А то в тех краях буря ожидается."
    ...
    mic "Кис-кис-кис…"
    mic "Светка меня убьет. Сначала за то, что ты сбежала, а потом за всё остальное."
    show blinking
    $ renpy.pause (1)
    ...
    $ persistent.sprite_time = "day"
    play ambience ambience_camp_center_day
    mic "А если ты нагуляешься, а потом корпус перепутаешь и придёшь к чужим людям? Тогда придется отказываться, врать, что не знаю, чья это кошка."
    ...
    mic "То есть нет — бурундука выслеживаю. Иду, смотрю бурундук сидит. Хотел его семечками угостить, а он убежал. Я за ним, но, кажется, увлекся."
    ...
    mic "Удрала котильда. А я даже объявления расклеить не могу. И на кой-черт мы её сюда притащили? Это всё Светка, её прихоть."
    mic "Ладно, если просто сбежала. Светка покричит, подуется и простит. А если её нашел кто? Это же ЧП и нарушение режима: домашнее животное на территории поселка."
    ...
    d_dy "Добрый вечер, жители поселка. Напоминаю, что начинается смена циклов, в связи с чем, с двадцати ноль-ноль пятницы и до восьми ноль-ноль понедельника, выход в ночное время из поселка запрещён."
    d_dy "Не рекомендуется также в ночное время выходить из зданий и сооружений без крайней необходимости. Исследовательские группы, находящиеся за пределами поселка, должны укрыться в экранированных убежищах."
    play sound sfx_radio_squelch_2
    mic "Вот так. А ведь я мог бы еще сегодня успеть и за территорией пробежаться. Забор-то вот он: рядом с корпусом. И дыр в этом заборе полно."
    ...
    "А когда стемнело, когда засвистело, с частотой пять с половиной килогерц, проволочное ограждение вокруг поселка, когда над забором вспыхнули тускло-красные огни, от земли начал подниматься туман."
    ...
    "Только поселок оставался в чистом пятне, да несколько пятен поменьше располагались в окружающих поселок лесах."
    ...
    "Сова спикировала на мышку, и никакой туман не помог той мышке укрыться. Так она и отправилась в свой последний полет в когтях совы."
    play sound dct_sfx_meow3
    ...
    "А туман продолжал стоять, молочно-белой стеной окружая поселок, иногда выпуская щупальце, которым касался ограды, пробуя её то ли на вкус, то ли на прочность."
    ...
    show cat_uv washing medium with dspr:
        pos (0.8, 0.7)
    play sound dct_sfx_meow4
    "Встала, как ни в чем не бывало, умылась и побежала к калитке в заборе."
    stop music fadeout 1
    stop ambience
    ...
    mic "Свет, она же по сути котенок еще, дети всегда меняются."
    ...
    "Вот только в ночь между циклами, когда Михаил засыпал или, бывало что днем, когда все были на работе, уже в кухонном окне открывалась форточка, темный силуэт выскальзывал наружу и устремлялся за забор, за пределы экранированной территории."
    show cat_uv waiting large with dspr:
        pos (0, 0.15)
    play sound dct_sfx_meow3
    $ renpy.pause (1)
    ...
    $ persistent.sprite_time = "day"
    play ambience ambience_int_cabin_day
    "Но утром форточка оказывалась запертой, а «кошкодевочка» как обычно караулила в засаде, чтобы, когда Михаил спустит ноги и всунет их в шлепанцы, атаковать его левую лодыжку."
    show cat_uv attacking large with dspr:
        pos (0.3, 0.3)
    play sound dct_sfx_meow2
    $ renpy.pause (1)
...
label dct_creature:
    ...
    hide cat_uv
    "Кошка шагнула на кухню и прикрыла за собой дверь. Постояла прислушиваясь, запрыгнула на подоконник, с подоконника — вертикально вверх к форточке, а там, зацепившись тремя лапами за переплёт, ухватилась четвертой за форточную завертку."
    ...
    "И когда язык тумана прикоснулся к её голове, она не упала в обморок, а только замерла, подавшись чуть вперед и тихо, незаметно для себя, мурлыкая."
    hide cat_uv with dspr
    ...
    show cat_uv walking2 medium with dspr:
        pos (0.25, 0.7)
    "Незадолго до рассвета, кошка тем же путем вернулась домой, прихватив по пути еще одну мышку."
    stop ambience
    ...
    play sound dct_sfx_meow6
    $ renpy.pause (1)
    mic "Вот тебе и «Мяу». Попадешься, рано или поздно, скандал будет."
    play sound dct_sfx_meow4
    $ renpy.pause (1)
    hide cat_uv with dspr
    stop music fadeout 1
    "Невнимательный к мелочам, как и большинство мужчин, Михаил совсем не обращал внимание на происходящие с кошкой перемены."
    "А вот хозяйка…"
    show blinking
    $ renpy.pause (2)
    show cat_uv waiting large with dspr:
    ...
    ms_s "Я её только погладила, а тут вот. И смотри, как голова у нее опухла. И шишки какие-то на теле и лапах. Может, её ветеринару показать? У тебя есть знакомые?"
    ...
    "В воскресенье ничего нового не произошло, а в понедельник Михаил ушел на работу с твердым намерением договориться с ветеринаром вивария. Светлана же, которой на работу надо было на час позже, осталась с кошкой наедине."
    ms_s "Чем же ты болеешь, киса? Нет, ничем ты не болеешь, вон какая веселая."
    ...
    hide cat_uv with dspr
    ms_s "Вкусная колбаска? А сейчас мы с мамой пойдем на прогулку. А то сколько тут живём, а ни разу не гуляли."
    ...
    "Заблудиться было невозможно. Держись вдоль реки и отойди от поселка как можно дальше. Самым трудным было пролезть сквозь дырку в заборе, но дальше все прошло как по маслу."
    ...
    "Удалившись от поселка километров на пять, и почти упершись здесь в Периметр, Светлана остановилась. Она когда-то читала, что кошки не отходят в своих странствиях от дома дальше, чем на два километра, поэтому посчитала расстояние достаточным."
    stop music fadeout 1
    ...
    mic "Может, вернется еще? Не переживай."
    stop ambience
    ...
    "А доча смогла, наконец, раздвинуть половинки молнии, выползти наружу и убежать перепуганная, сама не зная, куда. При этом она не замечала, что бежит на двух ногах, лишь изредка опускаясь на четвереньки. Для нее все перемены были естественными."
    $ set_mode_nvl ()
    ...
    "В общем-то, это была обычная жизнь дикой кошки: утром и вечером поймать по паре мышей, днем и ночью поспать."
    ...
    "Изменилось зрение, казалось, что всё пространство наполнено легкой светящейся дымкой, разрежённой в некоторых местах."
    "И если сделать определенное усилие, она бы не смогла объяснить какое, то можно, шагнув туда, в это место и сквозь это место, оказаться совсем в другом лесу."
    "Очень похожем на привычный, но всё же в другом. Шагнуть, поохотиться, но потом обязательно вернуться обратно."
    "О своих хозяевах и старом доме она почти не вспоминала. Так, две большие фигуры, весьма расплывчатые. И место, где не нужно было ловить мышей для пропитания, и где можно было спать на теплых коленях."
    "Что такое колени бывшая кошка помнила и понимала, потому что у нее самой теперь были почти такие же."
    stop music fadeout 1
    $ set_mode_adv ()
    stop ambience
    ...
    "Вот только центр этого промыслового участка постепенно смещался на восток, в сторону поселка, пока не совпал со Старым корпусом."
    stop ambience
    ...
    "И каждый из рассказчиков клянется, что «сам видел». Сам видел горящие глаза, клыки, когти, женскую фигуру, без одежды, но обросшую шерстью. Бывает. Ах да, еще и жуткий вой «сам слышал»."
    ...
    "Не надолго расшевелил дневального проверяющий, обходящий посты охраны. Поделился сигаретой, вставил пистон за затоптанный пол в будке и незаполненный журнал смены дежурств, и отбыл по центральной аллее в сторону площади."
    ...
    "Прямо на него через стекло смотрело Оно: горящие желтым светом глаза, хищные клыки, видимые в распахнутой пасти, звериные уши, торчащие над копной спутанных волос, лицо — смесь звериного и человеческого, тело, покрытое росшей клочками шерстью."
    ...
    $ persistent.sprite_time = "day"
    play ambience ambience_camp_center_day
    "Так рядового и нашли утром: лежащего в позе эмбриона на полу запертой изнутри будки (пришлось вынимать стекло), поседевшего, и повторявшего все время: «Докладывает дневальный по КПП: на поселок напал оборотень»."
    ...
    show d_ss normal shirt with moveinright:
        pos (0.4, -0.1)
    d_ss "Родственник, в поселке пока не показывайся."
    me "А что такое?"
    ...
    d_to "Я-то смогу её выследить и поймать, а вот ты — вернешь её такую на материк? Чтобы появился ещё один экспонат, ещё одно чучело в спецхранилище?"
    cs "И что? Ты предлагешь ничего не делать?"
    ...
    d_to "К бойцу тому она поласкаться и поиграть приходила, я уверен. А в следующий раз? А появится она в поселке вечером, после киносеанса? Будут гнать толпой через весь поселок, загонят в угол и убьют?"
...
label the_felinoid:
    ...
    show to_hunter with dspr
    "Анатолий шел в сторону старого лагеря. Механически разбирался в следах, оставленных людьми и животными на лесной тропинке и ворчал про себя."
    ...
    d_to "{i}Кажется, я не зря пришел.{/i}"
    stop ambience
        
    scene dct_cat_house_part3_footprint with moveinbottom
    $ day_time()
    $ persistent.sprite_time = "day"
    ...
    $ persistent.sprite_time = "day"
    play ambience ambience_old_camp_outside
    "Что-то мелькнуло слева. Анатолий сделал шаг в сторону, слившись с кустами. Потом медленно потянул с плеча ружье, на ходу переключая селектор на нарезной ствол."
    stop ambience
    ...
    $ persistent.sprite_time = "day"
    play ambience ambience_forest_day
    "Охотник прицелился, чуть подавшись туловищем назад, выдохнул, задержал дыхание, и плавно потянул спусковой крючок. Довел его до середины и опустил оружие."
    ...
    d_to "Пока еще это кошка. В почти человеческом облике, со сверхъестественными способностями, но кошка."
    stop sound_loop
    stop ambience
    ...
    show cs normal glasses at cleft with move
    ...
    play ambience ambience_int_cabin_day
    show d_to normal casual at center with dspr
    d_to "Вот, Женя, это твоё рабочее место. Приказы, картотека, личные дела сотрудников, график отпусков. И так далее, и тому подобнее. Разберешься?"
    hide d_to with moveoutright
    ...
    d_to "Да, Женя?"
    mz "Другие стажеры. Мику и этот, Сыроежкин. Я буду жить с ними в одной секции?"
    d_to "Что-то не так?"
    ...
    $ persistent.sprite_time = "day"
    play ambience ambience_forest_day
    "Из кошачьего у ней остались только длинный хвост и скрывающиеся под нечёсанной копной каштановых волос, треугольные подвижные уши. Всё, как и описал Анатолий. Единственное, что он не разглядел — это вертикальные зрачки в желтых глазах."
    "И её интеллект, интеллект пока спал. Интеллектом она пока оставалась ненамного выше той кошечки-подростка, какой была еще полгода назад."
    "Утром и вечером охотясь на мышей, дни и ночи она проводила подрёмывая или в Старом корпусе, или на одной из своих лёжек в лесу, окружающем поселок."
    ...
    "Кошке-девушке казалось, что что-то все сильнее и сильнее ограничивает ее свободу и это что-то рисовалось в её голове в образе невысокого человека с цепким и жестким взглядом."
    stop ambience
    ...
    d_to "Вы сейчас в будку{w=1}… то есть на удаленный пост?"
    us "Да. У меня…"
    ...
    d_to "Благодарю вас. И вашему Семену передайте эту же мою просьбу."
    hide d_us with moveoutright
    stop music fadeout 1
    stop ambience
    ...
    show d_bg normal suit with dspr
    d_gd "Будь осторожна, Виолетта. Однажды она спросит тебя человеческим голосом: «Ты пойдешь со мной?» А ты не сможешь ответить «Нет»."
    ...
    d_gd "Да, в общем, ни за чем. Будь осторожнее. Я попрошу армейцев восстановить туда телефонную линию. Вдруг поможет."
    stop ambience
    ...
    show cs shy with dspr
    cs "Но я хотя бы оставлю записи. Ты слушай, киса, слушай. Привыкай к моему голосу. Не важно, что ты пока ничего не понимаешь."
    stop ambience
    ...
    "И уже скоро в расположении значков стал виден определенный ритмически повторяющийся узор."
    ...
    show uv_spy_wild with dspr
    d_to "Кто сказал, что трудно ловить черную кошку в темной комнате? Это только вопрос системного подхода и правильной методики. Хоть ты и прыгаешь по узлам сети, как кошка по мебели."
    ...
    show to_hunter with dspr
    play ambience ambience_forest_day
    "Очень довольный собой охотник собрал рюкзак, затушил маленький костер и отправился в сторону лагеря."
    ...
    d_to "{i}Главное, опередить эту кису, пока она остается просто кисой. Или даже получеловеком.{/i}"
    stop ambience
    ...
    play ambience ambience_forest_day
    play music music_list ["mystery_girl_v2"]
    "Когда Анатолий ушел, кусты раздвинулись, и на поляну вышла кошка-девушка. Обошла по кругу место, где сидел Анатолий, то нагибаясь, чтобы рассмотреть следы получше, то отходя на несколько шагов."
    #ЦГ Дикая Юлька делает записи в лесу.
    "Присела на бревно, принимая при этом разные позы, подражая Анатолию."
    "Потом сбегала к росшему на краю поляны лопуху, оторвала от него самый большой лист, подобрала с земли обгорелую щепку и, опять усевшись на бревно, стала имитировать процесс письма, периодически зажимая второй конец щепки в зубах и издавая различные звуки, которые всё чаще и чаще складывались в двух-трехсложные сочетания."
    stop ambience
...
label dct_catgirl:
    ...
    $ persistent.sprite_time = "night"
    play ambience ambience_forest_night
    "А жизнь её была чем-то средним между жизнью пионеров, населяющих лагеря, и жизнью ученых, техников и военных, обитающих в посёлке."
    ...
    $ persistent.sprite_time = "night"
    play ambience ambience_camp_center_night
    "Всё также держась поблизости от поселка, бывшая кошка открыла для себя незаселенные узлы. Где можно было пройтись по абсолютно пустому лагерю, в котором никогда не звучали детские голоса."
    stop ambience
    ...
    $ persistent.sprite_time = "day"
    play ambience ambience_camp_center_day
    "Человек, неважно, был ли то пионер из лагеря, или обитатель поселка, или бывшая кошка, чувствовал в них себя очень неуютно."
    ...
    $ persistent.sprite_time = "night"
    play ambience ambience_camp_center_night
    "Ей казалось неправильным, что никто не живет в этих домиках, никто не ходит по аллеям, никто не принимает пищу в столовой и не играет на спортивной площадке."
    ...
    play ambience ambience_camp_center_day
    show uv_spy_wild with dspr
    "И всё же, бывшую кошку всё больше и больше тянуло к людям. Даже вечерняя погоня за ней, когда она едва спаслась от обитателей поселка, не отвратила её."
    ...
    "Полученный ей человеческий мозг был слишком велик для кошачьего разума и его требовалось чем-то заполнить."
    stop ambience
    ...
    "Она любила наблюдать за всеми людьми, но больше всего привлекали ее двое: женщина, которая с некоторых пор стала проводить время в её главном логове и мужчина, на которого она то и дело натыкалась в лесу."
    stop ambience
    ...
    "Иногда кошке-девушке казалось, что обращаются прямо к ней, иногда — что она понимает о чем идет речь. Но, как после наблюдения за мужчиной, хотелось в пантомиме повторить его действия, так и тут, каждый вечер она повторяла за женщиной как попугай, не понимая смысла произносимых слов."
    "Перед кошкой-девушкой стояла сложная задача: не понимая смысла слов, выделить те, которыми люди зовут друг друга. Чтобы самой потом позвать: \"Ты пойдешь со мной?\"."
    ...
    play ambience ambience_camp_center_day
    "И она опять и опять возвращалась в лагеря и в поселок, наблюдать за их обитателями."
    stop ambience
    ...
    th "Привязался я к ней. Может, оставить ее здесь постоянно? Надо будет потрясти Персунова-оригинала: как он умудряется сохранять своего дубликата в нашей вакуоли? А то надоело каждый цикл в лагерь мотаться."
    stop music fadeout 1
    stop ambience
    ...
    cs "А я пойду, у себя гостью подожду. У тебя своя программа встечи гостей, у меня — своя."
    ...
    $ persistent.sprite_time = "day"
    play ambience dct_ambience_old_house_wind
    "В старом корпусе Виола стояла вполоборота ко входу и делала вид, что внимательно разглядывает кончик карандаша. Фантазия у нее уже давно истощилась и потому она несла полную околесицу."
    ...
    "Виола тихо приговаривала не слушая себя, а сама, краем глаза, следила за старым зеркалом, принесенным в здание и прислоненным к стене так, чтобы в зеркале отражался вход. А там уже час как чувствовалось чьё-то присутствие."
    ...
    $ persistent.sprite_time = "day"
    play ambience dct_ambience_old_house_wind
    "Виола говорила и говорила, а кошачий хвост поднимался все выше и выше. И что-то сломалось в бывшей кошке, она сделала в комнату первый шаг, второй, третий и уткнулась головой в грудь Виолы, как утыкалась когда-то в колени хозяйки."
    ...
    cs "Нет, я была в поселке, а вот где ты была?"
    uv_cgl "Я-аа была-аа в поселке, а ты была-аа в лесу."
    cs "Так, стоп."
    ...
    "Девушка поняла и счастливо смеется. «Как просто!». Виола же так ни разу и не улыбнулась."
    stop music fadeout 1
    stop ambience
    ...
    play ambience ambience_int_cabin_day    
    cs "Видишь, можешь же."
    cs "Кто бы ещё рассказал мне, что с тобой делать? А ещё, как ты живешь с двумя наборами хромосом? Хотя, последнее — это уже личное, можешь не отвечать."
    ...
    "Помня свой неудачный опыт обращения к жителям поселка, она попробовала поговорить с пионерами, но пионеры либо не замечали её, либо испуганно убегали."
    show uv_spy_wild with dspr
    $ renpy.pause (2)
    ...
    play ambience ambience_forest_day
    show posp
    show uv laugh pioneer close behind posp
    $ renpy.pause (2)
    ...
    $ persistent.sprite_time = "day"
    play ambience ambience_forest_day
    d_to "Ладно, живи еще, срок до послезавтра ты заслужила."
    $ renpy.pause (1)
    stop ambience
...
label dct_goddess:
    ...
    play ambience ambience_old_camp_outside
    play music music_list["trapped_in_dreams"]
    "Прошел ещё один цикл, последний цикл, отведенный Анатолием девушке-кошке. А в остальном — ничем не примечательный."
    "Наверху, «на материке», как говорили в поселке, уже распалась Империя. Перемены докатились и до поселка: кого-то из обитателей возвращали на материк, кого-то просто сокращали."
    stop ambience
    ...
    $ persistent.sprite_time = "night"
    play ambience ambience_old_camp_outside
    "Сворачивались военные, закрывая свои, неизвестные гражданским, проекты и сокращая присутствие до неполной роты, охранявшей имущество, которое пока ещё не успели вывезти на материк."
    ...
    play ambience ambience_camp_center_day
    show uv_spy_neko
    "То, что люди, кроме Виолы, либо от нее убегают, либо её не замечают, стало привычным, и к людям она больше не подходила, наблюдая за их жизнью издалека."
    stop ambience
    ...
    stop ambience fadeout 3
    $ renpy.pause (3)
    "Или на пустую, продуваемую ледяным ветром равнину, украшенную только грудой черных камней."
    ...
    cs "Мне показалось неправильным, что мы не даем им шанса. Просто уничтожаем их."
    show cs shy with dspr
    d_to "Думаешь, ты первая? Сначала они хорошие, а потом в них просыпается. Нет, не зверь. Не знаю, что или кто."
    d_to "И они начинают таскать людей, сначала сюда, а потом на{w=1}… Не важно куда."
    show cs normal glasses with dspr
    cs "А мне стало её жалко."
    show cs normal with dspr
    d_to "Жалко."
    d_to "Мне кошку жалко. Может быть, человека было бы жалко. А вот это существо — нет. Так что, не проси меня ни о чем."
    ...
    "Пора было возвращаться в поселок и работать: вчера Глафира привезла приказ о ликвидации филиала и передаче материальных ценностей и результатов научных разработок вновь создаваемой коммерческой структуре. И надо было решить: что отдать, что оставить, а что уничтожить, как будто этого и не было."
    ...
    th "Я помню, как я бегала на четырех{w=1}… лапах и не умела разговаривать. Или умела? Не знаю, но люди меня не понимали."
    ...
    "Сейчас, когда порядок после обеда наведен, у девушки было немного времени, пока не начнут готовить ужин."
    "Девушка прислушалась. В столовой было тихо, только на кухне шумела вода, и с крыльца доносился разговор."
    "Пускай девушка и не понимала почти ничего, но разговор ее заинтересовал, ведь девушка любила наблюдать за людьми."
    ...
    d_ar_voice "Мы не знаем и десятой доли о здешних местах. Мало ли, что за неизученная живность в поселок забрела. И теперь уже не узнаем."
    ...
    "Это все подтверждается расчетами, но там столько переменных, что вывести можно всё что угодно."
    ...
    "А в Справочнике написано просто: «Экспедиция №13 — изучение узлов четвертого порядка (эфемерных узлов)»"
    "Информацию закрыли, но следы её можно найти в здешней библиотеке. А вот дальше уже мистика пойдет."
    nvl clear
    ...
    "А потом трассу к тем вакуолям стерли из памяти ЭВМ, поставили двойной барьер, непроницаемый для людей, и НБО, отчет экспедиции засекретили, а сами участники как-то быстро пропали."
    "Но и это ещё не все. Говорят, что среди наших пионеров-НБО иногда появляются копии людей оттуда, и кончается это трагедией. Либо резней в узле, либо узел просто исчезает."
    "Как попадают сюда из-за барьера? Да кто ж их знает. Например, в виде нейтринных колец. Для них-то все проницаемо."
    ...
    $ persistent.sprite_time = "day"
    play ambience ambience_dining_hall_empty
    d_vo_2 "Ты у меня спрашиваешь? Я человек практический, и люблю легенды слушать, а не придумывать. Ладно, побежал я, демонтаж у меня. А ты приходи через два часа, машина придет — будем твоё оборудование грузить."
    ...
    show d_ar adl smile2 casual with dspr
    d_ar_voice "Ты удивительно красивая. Не пойму, почему тебя назвали «оборотнем». Лучше я буду считать тебя{w=1}… нимфой, или лучше{w=1}… нэкой или, знаешь, была такая богиня, женщина-кошка, а звали ее{w=1}… Баст. Весьма положительный персонаж." 
    ...
    "Никуда он не пошел через два часа, так что лаборатория грузила оборудование без него."
    ...
    $ persistent.sprite_time = "day"
    play ambience ambience_forest_day
    "Они бродили, взявшись за руки, по всей Сети и говорили обо всем на свете."
    ...
    d_ar "Мне не о чем просить у мертвых."
    "Потом он склонился над алтарем, над каменным желобами, уходящими под основание пирамиды, над бронзовыми кольцами, вделанными в камни."
    "Вернулся к алтарю и провел пальцем по значкам, вырезанным на поверхности."
    d_ar "Египет."
    ...
    d_ar "Завтра я уеду, но я буду помнить, что влюбился настоящую богиню. Прощай."
    ...
    uv_cst "Я знаю, и тут я бессильна. Но не называй меня так. Лучше я буду обычной девушкой, пусть даже — девушкой-кошкой. И все-таки однажды я приду за тобой."
    show d_ar adl smile2 casual with dspr
    ...
    $ persistent.sprite_time = "day"
    play ambience ambience_camp_entrance_day
    "А когда автобус скрылся за восточными воротами; Генда на мгновение превратился в черный цилиндр, достающий до неба; а всех обитателей узла, где бы они не были, пробрал секундный озноб. Тогда ей стало так плохо, что она, забыв обещания, шагнула к черной пирамиде и, не задумываясь, приложила руки к углублениям в базальте."
    show gate_ext_pyramid:
        alpha 0
        ease 3 alpha 0.5
    $ renpy.pause (1)
    ...
    "Отстегнул. Забросил ружье на твердую землю, по соседству с полевой сумкой. Ремешок от полевой сумки и поясной ремень, уже связанные между собой, были намотаны на левую руку охотника."
    ...
    scene dct_to_in_bog with vpunch
    play sound dct_sfx_jump_in_swamp
    d_to "Толяныч, лежи и не дергайся! А то погружаешься. Отдышись и делай еще попытку."
    scene dct_to_in_bog with vpunch
    play sound dct_sfx_jump_in_swamp
    ...
    "Дерево изменило свое положение, и зацепиться не получалось, а каждый бросок чуть притапливал охотника."
    ...
    "Схватила ружьё, положила его стволами поперек сосенок-близнецов, обмотала конец ремня вокруг стволов. Сама схватилась ремень, сев на землю и уперевшись ногами."
    ...
    "Там такая удобная ветка, невысоко нависающая над землей. И есть зажигалка, которую подарил тот человек, на прощание."
    stop ambience
    ...
    $ persistent.sprite_time = "night"
    play ambience dct_ambience_bonfire
    "Можно развести костер, а самой запрыгнуть на ветку и смотреть на пламя сверху, как оно разгорается, пожирая сучья и как оно умирает, когда пища заканчивается."
    ...
    "Потрогать тыльной стороной ладони ещё теплое кострище и убежать к озеру умываться, а оттуда — на промысел еды."
    stop music fadeout 1
    stop ambience
    ...
    "Плакала девочка. Плакала где-то недалеко, за одним из выходов. Плакала горько и безнадежно. И девушка-кошка не задумываясь шагнула туда."
    stop sound
    stop ambience
    ...
    $ night_time ()
    $ persistent.sprite_time = "night"
    us "А я тебя помню. Я тебя видела в поселке год назад. Ты тогда была кошкой, а теперь выросла."
    uv_cgl "Я тоже тебя помню. Ты была большой, а стала маленькой. Ты обещала, что мы еще встретимся, вот и встретились. Так что случилось у тебя?"
    ...
    uv_cgl "Ну так пойдем. Ты пойдешь со мной?"
    us "Куда?"
    uv_cgl "Туда, где тебя обязательно найдет твой Сёмка."
    stop music fadeout 1
    stop ambience
    ...
    "Девушке-кошке достаточно одного шага, а вот девочка так не умеет и приходится идти дольше. Но это ничего не значит, потому что здесь, в тумане, время и расстояния — вещь субъективная."
    ...
    uv_cgl "Собой. Не бойся, это не больно. Ты ничего не потеряешь и ничего не почувствуешь. Просто у тебя появится много сестренок. Очень похожих на тебя, но в чем-то других. Совсем большой ты не станешь, но наполовину подрастешь. Где-то до границы детства. Дальше у меня силы нет, дальше — сама."
    us "Я согласна!"
    ...
    "Ладошка (ладошки, все, кроме одной) отцепляются и девочка бежит, обнимая медведя, к воротам."
    ...
    "Та идет, но у самого выхода оборачивается и машет рукой."
    ...
    "Она еще размышляет, не развести ли ей костер, но решает, что и так хорошо."
    show blink
    ...
    show promo_text u"По результатам наблюдений, ожидаемый срок трансформации объекта — не позднее 05 июня 1992 года.\nДоставка объекта в институт, в связи с ликвидацией филиала, невозможна.\nВследствие вышеизложенного, согласно Руководящей инструкции, и необходимостью оперативного реагирования, мною, по согласованию с руководством филиала, было принято решение об изъятии и ликвидации объекта.\nВ ходе оперативных мероприятий объект был блокирован и уничтожен 31 мая 1992 года в 20ч. 32м., в точке с координатами: Узел 22; квадрат 1134; квартал Ж6; в 55 метрах от центра квартала в направлении на репер Узла.\nРасход спецбоеприпасов — 1 патрон.\nВ связи с тем, что данная точка находится в болоте, достать физическое тело объекта без применения тяжелой техники и осушения болота не представляется возможным. Сфотографировать объект не удалось в связи с темным временем суток.\n\nПриложения:\n1. План местности с указанием точки захоронения объекта.\n2. Образец тканей объекта (волосы).\n\nЗаместитель руководителя филиала Института xxxxxx АН СССР, Г***в Анатолий Васильевич."  with dissolve:
        pos (0.02, 0.1)
    pause
    stop sound
